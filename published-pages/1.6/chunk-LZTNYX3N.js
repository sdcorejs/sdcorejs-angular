...
.full-page-preview {
  ...
  border: 1px solid #e4e7ec;
  border-radius: 8px;
}`},"components/document-builder":{typescript:`import { AfterViewInit, ChangeDetectionStrategy, Component, signal, viewChild } from '@angular/core';
import { DemoPageComponent, DemoSectionComponent } from '../../../shared/demo-page.component';
...
@Component({
  ...
  template: \`
    <demo-page #demoPage
      ...
      description="Tr\xECnh so\u1EA1n th\u1EA3o t\xE0i li\u1EC7u \u0111\u1EA7y \u0111\u1EE7 \u2014 \u0111\u1ECBnh d\u1EA1ng n\xE2ng cao, ch\xE8n b\u1EA3ng, \u1EA3nh, heading, bi\u1EBFn (variable), comment. D\xF9ng \u0111\u1EC3 d\u1EF1ng m\u1EABu h\u1EE3p \u0111\u1ED3ng, v\u0103n b\u1EA3n n\u1ED9i b\u1ED9.">
...
export class DocumentBuilderDemoComponent implements AfterViewInit {
  ...
  readonly defaultContent = \`
    ...
    <p>H\xF4m nay, ng\xE0y ____/____/______, t\u1EA1i v\u0103n ph\xF2ng c\xF4ng ty, ch\xFAng t\xF4i g\u1ED3m c\xF3:</p>
    <p><strong>B\xEAn A:</strong> C\xF4ng ty TNHH ABC</p>
    <p><strong>B\xEAn B:</strong> \xD4ng/B\xE0 ______________________, CCCD s\u1ED1 ______________</p>
    <h3>\u0110i\u1EC1u 1: C\xF4ng vi\u1EC7c v\xE0 \u0111\u1ECBa \u0111i\u1EC3m l\xE0m vi\u1EC7c</h3>
    <p>B\xEAn B \u0111\u1ED3ng \xFD l\xE0m vi\u1EC7c t\u1EA1i v\u1ECB tr\xED l\u1EADp tr\xECnh vi\xEAn, thu\u1ED9c ph\xF2ng C\xF4ng ngh\u1EC7 th\xF4ng tin.</p>
    <h3>\u0110i\u1EC1u 2: Th\u1EDDi h\u1EA1n h\u1EE3p \u0111\u1ED3ng</h3>
    <p>H\u1EE3p \u0111\u1ED3ng c\xF3 th\u1EDDi h\u1EA1n 12 th\xE1ng, k\u1EC3 t\u1EEB ng\xE0y k\xFD.</p>
    <h3>\u0110i\u1EC1u 3: L\u01B0\u01A1ng v\xE0 ph\xFAc l\u1EE3i</h3>
    <p>M\u1EE9c l\u01B0\u01A1ng c\u01A1 b\u1EA3n l\xE0 20.000.000 VN\u0110 m\u1ED7i th\xE1ng.</p>
  \`;

  readonly htmlOutput = signal<string>('');

  ngAfterViewInit(): void {
    // Document Builder kh\xF4ng c\xF3 @Input content \u2014 ph\u1EA3i g\u1ECDi setContent sau khi view init.
...
@Component({
  ...
  template: \`
    <demo-page #demoPage title="Date" description="sd-date \u2013 ch\u1ECDn 1 ng\xE0y, hi\u1EC3n th\u1ECB theo \u0111\u1ECBnh d\u1EA1ng dd/MM/yyyy. Bind hai chi\u1EC1u v\u1EDBi chu\u1ED7i ISO.">
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-co-ban') {
      <demo-section heading="C\u01A1 b\u1EA3n" [props]="[{ name: '[(model)]', value: 'two-way' }]" note="M\u1EDF l\u1ECBch v\xE0 ch\u1ECDn ng\xE0y.">
        <div style="width: 320px; display:flex; flex-direction:column; gap:8px">
          <sd-date label="Ng\xE0y sinh" helperText="Theo CMND/CCCD"
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-validator') {
      <demo-section heading="Validator" [props]="[{ name: 'required', value: 'true' }]" note="\u0110\u1EC3 tr\u1ED1ng v\xE0 b\u1EA5m Ki\u1EC3m tra \u0111\u1EC3 hi\u1EC7n l\u1ED7i inline.">
        <div style="width: 320px; display:flex; flex-direction:column; gap:12px">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-chinh-sua-noi-tuyen') {
      <demo-section heading="Ch\u1EC9nh s\u1EEDa n\u1ED9i tuy\u1EBFn" [props]="[{ name: 'viewed', value: 'inline' }]" note="B\u1EA5m v\xE0o ng\xE0y \u0111\u1EC3 m\u1EDF l\u1ECBch ngay; text gi\u1EEF nguy\xEAn t\u1EDBi khi ch\u1ECDn. Hover hi\u1EC7n \xD7 \u0111\u1EC3 xo\xE1.">
...
`},"forms/date-range":{typescript:`import { ChangeDetectionStrategy, Component, signal } from '@angular/core';
import { FormGroup, FormsModule, ReactiveFormsModule } from '@angular/forms';
import { DemoPageComponent, DemoSectionComponent } from '../../../shared/demo-page.component';
...
@Component({
  ...
  template: \`
    <demo-page #demoPage title="Date Range" description="sd-date-range \u2013 ch\u1ECDn kho\u1EA3ng th\u1EDDi gian t\u1EEB \u2013 \u0111\u1EBFn. Model l\xE0 object { from, to } d\u1EA1ng ISO.">
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-co-ban') {
      <demo-section heading="C\u01A1 b\u1EA3n" [props]="[{ name: '[(model)]', value: 'two-way' }]" note="Ch\u1ECDn ng\xE0y b\u1EAFt \u0111\u1EA7u v\xE0 ng\xE0y k\u1EBFt th\xFAc trong c\xF9ng popup.">
        <div style="width: 380px; display:flex; flex-direction:column; gap:8px">
          <sd-date-range label="Kho\u1EA3ng th\u1EDDi gian b\xE1o c\xE1o" helperText="Ch\u1ECDn ng\xE0y b\u1EAFt \u0111\u1EA7u v\xE0 k\u1EBFt th\xFAc"
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-trang-thai') {
      <demo-section heading="Tr\u1EA1ng th\xE1i" [props]="[{ name: 'disabled', value: 'true' }, { name: 'viewed', value: 'true' }]" note="Kho\u1EA3ng \u0111\xE3 set s\u1EB5n.">
        <div style="display:flex; gap:16px; flex-wrap:wrap; width:100%">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-chinh-sua-noi-tuyen') {
      <demo-section heading="Ch\u1EC9nh s\u1EEDa n\u1ED9i tuy\u1EBFn" [props]="[{ name: 'viewed', value: 'inline' }]" note="B\u1EA5m v\xE0o kho\u1EA3ng \u0111\u1EC3 m\u1EDF l\u1ECBch ch\u1ECDn; text gi\u1EEF nguy\xEAn t\u1EDBi khi ch\u1ECDn. Hover hi\u1EC7n \xD7 \u0111\u1EC3 xo\xE1.">
...
@Component({
  ...
  template: \`
    <demo-page #demoPage title="Datetime" description="sd-datetime \u2013 ch\u1ECDn ng\xE0y + gi\u1EDD trong c\xF9ng m\u1ED9t control. Bind hai chi\u1EC1u v\u1EDBi chu\u1ED7i 'YYYY-MM-DD HH:mm'.">
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-co-ban') {
      <demo-section heading="C\u01A1 b\u1EA3n" [props]="[{ name: '[(model)]', value: 'two-way' }]" note="M\u1EDF popup picker \u0111\u1EC3 ch\u1ECDn ng\xE0y v\xE0 gi\u1EDD.">
        <div style="width: 340px; display:flex; flex-direction:column; gap:8px">
          <sd-datetime label="Th\u1EDDi \u0111i\u1EC3m cu\u1ED9c h\u1ECDp" helperText="Bao g\u1ED3m ng\xE0y v\xE0 gi\u1EDD"
            [(model)]="meeting" [form]="form"></sd-datetime>
          <div style="font-size:12px; color:#555">Gi\xE1 tr\u1ECB: <b>{{ meeting() || '(tr\u1ED1ng)' }}</b></div>
        </div>
      </demo-section>
      }
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-trang-thai') {
      <demo-section heading="Tr\u1EA1ng th\xE1i" [props]="[{ name: 'disabled', value: 'true' }, { name: 'viewed', value: 'true' }]" note="Hai tr\u1EA1ng th\xE1i kh\xF4ng cho ch\u1EC9nh s\u1EEDa.">
        <div style="display:flex; gap:16px; flex-wrap:wrap; width:100%">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-chinh-sua-noi-tuyen') {
      <demo-section heading="Ch\u1EC9nh s\u1EEDa n\u1ED9i tuy\u1EBFn" [props]="[{ name: 'viewed', value: 'inline' }]" note="B\u1EA5m v\xE0o \u0111\u1EC3 m\u1EDF overlay datetime; text gi\u1EEF nguy\xEAn t\u1EDBi khi ch\u1ECDn. Hover hi\u1EC7n \xD7 \u0111\u1EC3 xo\xE1.">
...
`},"services/docx":{typescript:`import { ChangeDetectionStrategy, Component, inject, signal } from '@angular/core';
import { MatButtonModule } from '@angular/material/button';
import { DemoPageComponent, DemoSectionComponent } from '../../../shared/demo-page.component';
...
@Component({
  ...
  imports: [DemoPageComponent, DemoSectionComponent, MatButtonModule],
  template: \`
    <demo-page #demoPage title="Docx" description="SdDocxService \u2013 chuy\u1EC3n \u0111\u1ED5i file .docx sang HTML qua pandoc.wasm. API ch\xEDnh: open() m\u1EDF file picker; convertToHtml(file) / convertToHtmlString(file) chuy\u1EC3n tr\u1EF1c ti\u1EBFp m\u1ED9t File/Blob.">
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-mo-file-docx') {
      <demo-section heading="M\u1EDF file .docx" [props]="[{ name: 'open()', value: 'method' }]" note="open() \u2013 m\u1EDF file picker, \u0111\u1ECDc file, g\u1ECDi pandoc.wasm, tr\u1EA3 v\u1EC1 { html, messages }. WASM \u0111\u01B0\u1EE3c t\u1EA3i l\u1EA7n \u0111\u1EA7u (~v\xE0i MB) n\xEAn c\xF3 th\u1EC3 ch\u1EADm.">
      ...
      <demo-section heading="Chuy\u1EC3n \u0111\u1ED5i sang HTML" [props]="[{ name: 'convertToHtmlString()', value: 'method' }]" note="convertToHtmlString() \u2013 kh\xF4ng tr\u1EA3 m\u1EA3ng c\u1EA3nh b\xE1o.">
...
export class DocxDemoComponent {
  ...
  async onOpen() {
    this.busy.set(true);
    this.status.set('\u0110ang x\u1EED l\xFD...');
    try {
      const result = await this.#docx.open();
      if (!result) {
        this.status.set('\u0110\xE3 h\u1EE7y ho\u1EB7c kh\xF4ng c\xF3 file.');
        this.preview.set(null);
      } else {
        this.status.set(\`Th\xE0nh c\xF4ng. \${result.messages.length} c\u1EA3nh b\xE1o.\`);
  ...
  async onOpenString() {
    ...
    try {
      ...
      if (html == null) {
        this.status.set('\u0110\xE3 h\u1EE7y ho\u1EB7c l\u1ED7i chuy\u1EC3n \u0111\u1ED5i.');
        this.preview.set(null);
      } else {
        this.status.set('\u0110\xE3 chuy\u1EC3n \u0111\u1ED5i sang HTML.');
...
<div style="width: 240px;">
  <sd-button type="fill" color="primary" title="block" [block]="true"></sd-button>
    ...
    </demo-section>`}),"components/document-builder/example-soan-mau-hop-dong":t(e({},o["components/document-builder"]),{html:`<demo-section heading="So\u1EA1n m\u1EABu h\u1EE3p \u0111\u1ED3ng" [props]="[{ name: 'option', value: 'config' }, { name: 'contentChange', value: 'event' }]">
    <div class="doc-box">
      <sd-document-builder
        style="height: 100%; width: 100%"
        [option]="builderOption"
  ...
  </demo-section>`}),"forms/date-range/example-chinh-sua-noi-tuyen":t(e({},o["forms/date-range"]),{html:`<demo-section heading="Ch\u1EC9nh s\u1EEDa n\u1ED9i tuy\u1EBFn" [props]="[{ name: 'viewed', value: 'inline' }]" note="B\u1EA5m v\xE0o kho\u1EA3ng \u0111\u1EC3 m\u1EDF l\u1ECBch ch\u1ECDn; text gi\u1EEF nguy\xEAn t\u1EDBi khi ch\u1ECDn. Hover hi\u1EC7n \xD7 \u0111\u1EC3 xo\xE1.">
    <div style="width: 340px; font-size:13px; color:#555">
      K\u1EF3: <sd-date-range [viewed]="'inline'" [(model)]="lockedB" [form]="form"></sd-date-range>
    </div>
  </demo-section>`}),"forms/date-range/example-co-ban":t(e({},o["forms/date-range"]),{html:`<demo-section heading="C\u01A1 b\u1EA3n" [props]="[{ name: '[(model)]', value: 'two-way' }]" note="Ch\u1ECDn ng\xE0y b\u1EAFt \u0111\u1EA7u v\xE0 ng\xE0y k\u1EBFt th\xFAc trong c\xF9ng popup.">
    <div style="width: 380px; display:flex; flex-direction:column; gap:8px">
      <sd-date-range label="Kho\u1EA3ng th\u1EDDi gian b\xE1o c\xE1o" helperText="Ch\u1ECDn ng\xE0y b\u1EAFt \u0111\u1EA7u v\xE0 k\u1EBFt th\xFAc"
        [(model)]="period" [form]="form"></sd-date-range>
      <div style="font-size:12px; color:#555">
  ...
  </demo-section>`}),"forms/date-range/example-trang-thai":t(e({},o["forms/date-range"]),{html:`<demo-section heading="Tr\u1EA1ng th\xE1i" [props]="[{ name: 'disabled', value: 'true' }, { name: 'viewed', value: 'true' }]" note="Kho\u1EA3ng \u0111\xE3 set s\u1EB5n.">
    <div style="display:flex; gap:16px; flex-wrap:wrap; width:100%">
      <sd-date-range style="width: 300px" label="disabled" [(model)]="lockedA" [form]="form" disabled></sd-date-range>
      <sd-date-range style="width: 300px" label="viewed" [(model)]="lockedB" [form]="form" viewed></sd-date-range>
    </div>
  ...
  </demo-section>`}),"forms/date/example-chinh-sua-noi-tuyen":t(e({},o["forms/date"]),{html:`<demo-section heading="Ch\u1EC9nh s\u1EEDa n\u1ED9i tuy\u1EBFn" [props]="[{ name: 'viewed', value: 'inline' }]" note="B\u1EA5m v\xE0o ng\xE0y \u0111\u1EC3 m\u1EDF l\u1ECBch ngay; text gi\u1EEF nguy\xEAn t\u1EDBi khi ch\u1ECDn. Hover hi\u1EC7n \xD7 \u0111\u1EC3 xo\xE1.">
    <div style="width: 260px; font-size:13px; color:#555">
      Ng\xE0y sinh: <sd-date [viewed]="'inline'" [(model)]="lockedB" [form]="form"></sd-date>
    </div>
  ...
  </demo-section>`}),"forms/date/example-trang-thai":t(e({},o["forms/date"]),{html:`<demo-section heading="Tr\u1EA1ng th\xE1i" [props]="[{ name: 'disabled', value: 'true' }, { name: 'viewed', value: 'true' }]" note="Hai tr\u1EA1ng th\xE1i kho\xE1.">
    <div style="display:flex; gap:16px; flex-wrap:wrap; width:100%">
      <sd-date style="width: 240px" label="disabled" [(model)]="lockedA" [form]="form" disabled></sd-date>
      <sd-date style="width: 240px" label="viewed" [(model)]="lockedB" [form]="form" viewed></sd-date>
    </div>
  </demo-section>`}),"forms/date/example-validator":t(e({},o["forms/date"]),{html:`<demo-section heading="Validator" [props]="[{ name: 'required', value: 'true' }]" note="\u0110\u1EC3 tr\u1ED1ng v\xE0 b\u1EA5m Ki\u1EC3m tra \u0111\u1EC3 hi\u1EC7n l\u1ED7i inline.">
    <div style="width: 320px; display:flex; flex-direction:column; gap:12px">
      <sd-date label="required"
        [(model)]="startDate" [form]="formValid" required></sd-date>
      <div style="display:flex; gap:8px">
  ...
  </demo-section>`}),"forms/datetime/example-chinh-sua-noi-tuyen":t(e({},o["forms/datetime"]),{html:`<demo-section heading="Ch\u1EC9nh s\u1EEDa n\u1ED9i tuy\u1EBFn" [props]="[{ name: 'viewed', value: 'inline' }]" note="B\u1EA5m v\xE0o \u0111\u1EC3 m\u1EDF overlay datetime; text gi\u1EEF nguy\xEAn t\u1EDBi khi ch\u1ECDn. Hover hi\u1EC7n \xD7 \u0111\u1EC3 xo\xE1.">
    <div style="width: 300px; font-size:13px; color:#555">
      H\u1EB9n l\xFAc: <sd-datetime [viewed]="'inline'" [(model)]="lockedB" [form]="form"></sd-datetime>
    </div>
  ...
  </demo-section>`}),"forms/datetime/example-trang-thai":t(e({},o["forms/datetime"]),{html:`<demo-section heading="Tr\u1EA1ng th\xE1i" [props]="[{ name: 'disabled', value: 'true' }, { name: 'viewed', value: 'true' }]" note="Hai tr\u1EA1ng th\xE1i kh\xF4ng cho ch\u1EC9nh s\u1EEDa.">
    <div style="display:flex; gap:16px; flex-wrap:wrap; width:100%">
      <sd-datetime style="width: 260px" label="disabled" [(model)]="lockedA" [form]="form" disabled></sd-datetime>
      <sd-datetime style="width: 260px" label="viewed" [(model)]="lockedB" [form]="form" viewed></sd-datetime>
    </div>
    ...
    <button mat-flat-button color="warn" (click)="onDelete()">X\xF3a b\u1EA3n ghi</button>
  </demo-section>`}),"services/docx/example-chuyen-doi-sang-html":t(e({},o["services/docx"]),{html:`<demo-section heading="Chuy\u1EC3n \u0111\u1ED5i sang HTML" [props]="[{ name: 'convertToHtmlString()', value: 'method' }]" note="convertToHtmlString() \u2013 kh\xF4ng tr\u1EA3 m\u1EA3ng c\u1EA3nh b\xE1o.">
    <button mat-stroked-button color="primary" [disabled]="busy()" (click)="onOpenString()">Ch\u1ECDn file & l\u1EA5y HTML</button>
  </demo-section>`}),"services/docx/example-ket-qua":t(e({},o["services/docx"]),{html:`<demo-section heading="K\u1EBFt qu\u1EA3">
    <div style="width:100%">
      <div style="font-size:12px;color:#666;margin-bottom:6px">{{ status() }}</div>
      @if (preview()) {
        <div style="max-height:280px;overflow:auto;border:1px solid #ddd;border-radius:6px;padding:12px;background:#fff" [innerHTML]="preview()"></div>
  ...
  </demo-section>`}),"services/docx/example-mo-file-docx":t(e({},o["services/docx"]),{html:`<demo-section heading="M\u1EDF file .docx" [props]="[{ name: 'open()', value: 'method' }]" note="open() \u2013 m\u1EDF file picker, \u0111\u1ECDc file, g\u1ECDi pandoc.wasm, tr\u1EA3 v\u1EC1 { html, messages }. WASM \u0111\u01B0\u1EE3c t\u1EA3i l\u1EA7n \u0111\u1EA7u (~v\xE0i MB) n\xEAn c\xF3 th\u1EC3 ch\u1EADm.">
    <button mat-flat-button color="primary" [disabled]="busy()" (click)="onOpen()">Ch\u1ECDn file .docx</button>

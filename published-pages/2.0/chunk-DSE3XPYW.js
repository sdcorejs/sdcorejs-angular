        ...
        <div class="tree-demo-panel">
          <sd-tree [option]="customDemoOption">
            <ng-template sdTreeItemDef let-item let-level="level" let-isLeaf="isLeaf" let-toggle="toggle">
              <!-- why: SdTreeItemDefDirective m\u1EB7c \u0111\u1ECBnh generic l\xE0 unknown (kh\xE1c SdOrgChartItemDef,
                   v\u1ED1n default v\u1EC1 type node c\u1EE5 th\u1EC3), n\xEAn d\u01B0\u1EDBi strictTemplates item kh\xF4ng \u0111\u1ECDc \u0111\u01B0\u1EE3c
                   property n\xE0o. Alias qua @let + cast m\u1ED9t l\u1EA7n thay v\xEC r\u1EA3i $any() kh\u1EAFp template. -->
              @let _node = $any(item);

    ...
    selector: {
      ...
      actions: [{
        title: 'X\u1EED l\xFD \u0111\xE3 ch\u1ECDn', icon: 'checklist', children: [
          ...
          { title: 'X\xF3a', icon: 'delete', color: 'error', click: rows => alert('X\xF3a ' + rows?.length + ' s\u1EA3n ph\u1EA9m') },
        ],
      }],
    },
    command: {
...
<sd-button type="outline" color="secondary" title="Kh\xF4ng kh\u1EA3 d\u1EE5ng" prefixIcon="download" disabled autoId="disabled-outline"></sd-button>`}),"components/card/example-disabled-va-color":t(e({},o["components/card/example-disabled-va-color"]),{html:`<div class="example-stack">

...
@Component({
  ...
  template: \`
    <demo-page #demoPage
      title="Avatar"
      description="\u1EA2nh \u0111\u1EA1i di\u1EC7n tr\xF2n \u2014 ch\u1EEF c\xE1i \u0111\u1EA7u \u0111\u1EADm tr\xEAn n\u1EC1n light, m\xE0u c\u1ED1 \u0111\u1ECBnh theo t\xEAn khi kh\xF4ng c\xF3 URL \u1EA3nh.">
...
@Component({
  ...
  template: \`
    <demo-page #demoPage title="Badge" description="Nh\xE3n tr\u1EA1ng th\xE1i / s\u1ED1 \u0111\u1EBFm \u2014 c\xF3 3 d\u1EA1ng (type): icon, round, tag.">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-icon-va-noi-dung-dai') {
        <demo-section
          heading="Icon v\xE0 n\u1ED9i dung d\xE0i"
          [props]="[
            { name: 'type', value: 'icon' },
            { name: 'size', value: 'sm / md / lg' },
          ]"
          note="Icon gi\u1EEF nguy\xEAn k\xEDch th\u01B0\u1EDBc v\xE0 c\u0103n gi\u1EEFa v\u1EDBi to\xE0n b\u1ED9 ph\u1EA7n ch\u1EEF khi n\u1ED9i dung xu\u1ED1ng d\xF2ng.">
          <div style="display:flex;flex-wrap:wrap;gap:24px">
            @for (size of iconSizes; track size) {
              <sd-badge
                ...
                icon="check_circle"
                color="success"
                title="\u0110\xE3 x\xE1c nh\u1EADn th\xF4ng tin kh\xE1ch h\xE0ng"
...
`},"components/button/example-action-popover":{typescript:`import { ChangeDetectionStrategy, Component, signal } from '@angular/core';
...
.button-toolbar {
  ...
  gap: 8px;
  flex-basis: 100%;
}`},"components/card/example-disabled-va-color":{typescript:`import { ChangeDetectionStrategy, Component, signal } from '@angular/core';
...
.model-readout {
  ...
  font-family: 'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace;
  font-size: 12px;
}`},"components/card/example-multiple-selection":{typescript:`import { ChangeDetectionStrategy, Component, computed, signal } from '@angular/core';
import { SdCard, SdCardGroup } from '@sdcorejs/angular/components/card';
...
.model-readout {
  ...
  font-family: 'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace;
  font-size: 12px;
}`},"components/card/example-object-comparewith":{typescript:`import { ChangeDetectionStrategy, Component, signal } from '@angular/core';
...
.model-readout {
  ...
  font-family: 'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace;
  font-size: 12px;
}`},"components/card/example-single-selection":{typescript:`import { ChangeDetectionStrategy, Component, signal } from '@angular/core';
import { SdCard, SdCardGroup } from '@sdcorejs/angular/components/card';
...
export class CardSingleExampleComponent {
  readonly statuses: StatusOption[] = [
    ...
    { code: 'archived', name: '\u0110\xE3 l\u01B0u tr\u1EEF' },
  ];
  readonly selectedStatus = signal<StatusOption | null>(null);
  readonly lastChange = signal('Ch\u01B0a c\xF3 interaction');
...
.model-readout {
  ...
  font-family: 'SFMono-Regular', Consolas, 'Liberation Mono', Menlo, monospace;
  font-size: 12px;
}`},"components/card/example-standalone-card":{typescript:`import { ChangeDetectionStrategy, Component, signal } from '@angular/core';
  ...
  template: \`
    <demo-page
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-loi-va-retry-tren-ba-control') {
        <demo-section
          heading="L\u1ED7i v\xE0 retry tr\xEAn ba control"
          [props]="[{ name: 'readState / sdReadStateChange', value: 'idle \u2192 loading \u2192 ready / empty / error' }]">
          <p>
            Ban \u0111\u1EA7u m\xE1y ch\u1EE7 m\xF4 ph\u1ECFng tr\u1EA3 l\u1ED7i. Ch\u1ECDn \u201CC\xF3 d\u1EEF li\u1EC7u\u201D ho\u1EB7c \u201CR\u1ED7ng h\u1EE3p l\u1EC7\u201D, r\u1ED3i b\u1EA5m Th\u1EED l\u1EA1i tr\xEAn control. Ch\u1ECDn \u201CTi\u1EBFp t\u1EE5c l\u1ED7i\u201D \u0111\u1EC3 th\u1EED
            l\u1ED7i li\xEAn ti\u1EBFp. Select \u0111\u1ECDc ri\xEAng VALUE v\xE0 SEARCH n\xEAn c\xF3 th\u1EC3 c\u1EA7n retry t\u1EEBng k\xEAnh.
          </p>
          <div class="demo-actions">
            <button type="button" [attr.aria-pressed]="mode() === 'ready'" (click)="mode.set('ready')">C\xF3 d\u1EEF li\u1EC7u</button>
          ...
          <div class="control-grid">
            <div>
              <sd-select
                #select
                label="Select \u2014 template l\u1ED7i ri\xEAng"
                [items]="loadSelect"
                valueField="id"
                displayField="name"
                [(model)]="selected"
              ...
              <p>Gi\xE1 tr\u1ECB: {{ selected() }}. Output: {{ latest().select }}</p>
            </div>
            <div>
              <sd-autocomplete
                #autocomplete
              ...
              <p>Gi\xE1 tr\u1ECB: {{ autocompleteValue() }}. Output: {{ latest().autocomplete }}</p>
              <label
                ><input type="checkbox" [checked]="hideReadError()" (change)="hideReadError.set(!hideReadError())" /> Host hi\u1EC3n th\u1ECB l\u1ED7i b\xEAn
                ngo\xE0i</label
              >
          ...
          <p>
            M\u1EDF panel l\u1ED7i v\xE0 nh\u1EA5n Tab \u0111\u1EC3 t\u1EDBi retry; Enter/Space \u0111\u1EC3 th\u1EED l\u1EA1i, Escape \u0111\u1EC3 \u0111\xF3ng panel. Gi\xE1 tr\u1ECB \u0111\xE3 ch\u1ECDn kh\xF4ng b\u1ECB x\xF3a khi \u0111\u1ECDc l\u1ED7i.
          </p>
        </demo-section>
      }
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-panel-hep-va-lua-chon-dang-giu') {
        <demo-section
          heading="Panel h\u1EB9p v\xE0 l\u1EF1a ch\u1ECDn \u0111ang gi\u1EEF"
          [props]="[
            { name: 'multiple', value: 'true' },
            { name: 'minWidthPanel', value: '180px' },
          ]"
          note="L\u1ED7i n\u1EB1m gi\u1EEFa, d\u01B0\u1EDBi c\xE1c m\u1EE5c \u0111\xE3 ch\u1ECDn. Panel 180px v\u1EABn \u0111\u1ECDc \u0111\u01B0\u1EE3c th\xF4ng b\xE1o v\xE0 b\u1EA5m Th\u1EED l\u1EA1i.">
...
export class DataStateDemoComponent {
  readonly narrowSelectItems: SdSearch<DemoRow> = request =>
    request.type === 'VALUE'
      ? Promise.resolve([
          { id: 1, name: '\u0110\xE3 ch\u1ECDn A' },
          { id: 2, name: '\u0110\xE3 ch\u1ECDn B' },
        ])
  ...
  readonly rows: DemoRow[] = [
    { id: 1, name: 'H\xE0 N\u1ED9i' },
    { id: 2, name: '\u0110\xE0 N\u1EB5ng' },
    { id: 3, name: 'TP. H\u1ED3 Ch\xED Minh' },
  ];
...
`,scss:`.editor-box {
  width: 100%;
  max-width: 720px;
}`},"components/file-explorer":{typescript:`import { ChangeDetectionStrategy, Component, signal } from '@angular/core';
import { DemoPageComponent, DemoSectionComponent } from '../../../shared/demo-page.component';
...
function seed(): DemoEntry[] {
  ...
  return [
    { id: 'du-an', parentId: null, name: 'D\u1EF1 \xE1n', kind: 'folder' },
    ...
    { id: 'tai-lieu', parentId: null, name: 'T\xE0i li\u1EC7u', kind: 'folder', hasChildren: false },
    { id: 'hinh-anh', parentId: null, name: 'H\xECnh \u1EA3nh', kind: 'folder', hasChildren: false },
    {
      id: 'huong-dan',
      parentId: null,
    ...
    { id: 'brief', parentId: 'du-an', name: 'Brief d\u1EF1 \xE1n.docx', kind: 'file', mimeType: DOCX, size: 48_128, modifiedAt: now - 5 * DAY, content: doc('Brief') },
    ...
    { id: 'quy-trinh', parentId: 'tai-lieu', name: 'Quy tr\xECnh ph\xEA duy\u1EC7t.pdf', kind: 'file', mimeType: 'application/pdf', size: 1_153_433, modifiedAt: now - 2 * DAY, content: () => pdfBlob('Quy trinh phe duyet') },
    ...
    { id: 'bao-cao', parentId: 'tai-lieu', name: 'B\xE1o c\xE1o qu\xFD 3.xlsx', kind: 'file', mimeType: XLSX, size: 530_432, modifiedAt: now - 6 * DAY, content: csv },
    {
      id: 'banner',
      parentId: 'hinh-anh',
...
class DemoDrive {
  ...
  async upload(file: File, parentId: string | null, progress: (loaded: number, total?: number) => void, signal: AbortSignal) {
    ...
    if (normalize(file.name).includes('loi')) throw new Error('M\xE1y ch\u1EE7 t\u1EEB ch\u1ED1i t\u1EC7p n\xE0y (m\xF4 ph\u1ECFng l\u1ED7i).');
  ...
  async createFolder(parentId: string | null, name: string): Promise<SdFileExplorerItem> {
    ...
    if (exists) throw new Error(\`\u0110\xE3 c\xF3 m\u1EE5c t\xEAn "\${name}" trong th\u01B0 m\u1EE5c n\xE0y.\`);
...
@Component({
  ...
  template: \`
    <demo-page
      #demoPage
      title="File Explorer"
      description="Tr\xECnh duy\u1EC7t t\u1EC7p ki\u1EC3u Google Drive trong m\u1ED9t th\u1EBB: c\xE2y th\u01B0 m\u1EE5c, breadcrumb, list/grid, t\xECm ki\u1EBFm, xem tr\u01B0\u1EDBc \u1EA3nh/PDF, t\u1EA3i l\xEAn k\xE9o th\u1EA3, t\u1EA3i xu\u1ED1ng v\xE0 h\xE0ng \u0111\u1EE3i truy\u1EC1n t\u1EC7p. Kh\xF4ng ph\u1EE5 thu\u1ED9c backend \u2014 m\u1ECDi thao t\xE1c \u0111i qua callback c\u1EE7a option.">
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-day-du-tinh-nang') {
        <demo-section
          heading="\u0110\u1EA7y \u0111\u1EE7 t\xEDnh n\u0103ng"
          [props]="[
            { name: 'option.list', value: 'lazy theo th\u01B0 m\u1EE5c' },
            { name: 'option.search', value: 'debounce 300ms' },
            { name: 'option.preview', value: 'Blob \u1EA3nh / PDF' },
            { name: 'option.upload', value: 'ch\u1ECDn nhi\u1EC1u + k\xE9o th\u1EA3' },
          ...
          note="K\xE9o th\u1EA3 t\u1EC7p v\xE0o explorer ho\u1EB7c b\u1EA5m T\u1EA3i t\u1EC7p l\xEAn. T\xEAn t\u1EC7p c\xF3 ch\u1EEF \u201Cloi\u201D s\u1EBD m\xF4 ph\u1ECFng l\u1ED7i \u0111\u1EC3 th\u1EED n\xFAt Th\u1EED l\u1EA1i; h\u1EE7y \u0111\u01B0\u1EE3c khi \u0111ang chu\u1EA9n b\u1ECB ho\u1EB7c \u0111ang truy\u1EC1n.">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-chi-xem-va-tai-xuong') {
        <demo-section
          heading="Ch\u1EC9 xem v\xE0 t\u1EA3i xu\u1ED1ng"
          [props]="[
            { name: 'option.upload', value: 'kh\xF4ng truy\u1EC1n' },
            { name: 'option.createFolder', value: 'kh\xF4ng truy\u1EC1n' },
            { name: 'option.search', value: 'l\u1ECDc t\u1EA1i ch\u1ED7' },
            { name: 'option.download', value: 'tr\u1EA3 void (tr\xECnh duy\u1EC7t t\u1EF1 t\u1EA3i)' },
            { name: 'option.defaultView', value: 'grid' }
          ]"
          note="Callback n\xE0o kh\xF4ng \u0111\u01B0\u1EE3c cung c\u1EA5p th\xEC UI t\u01B0\u01A1ng \u1EE9ng bi\u1EBFn m\u1EA5t. Kh\xF4ng c\xF3 search n\xEAn \xF4 t\xECm ki\u1EBFm l\u1ECDc danh s\xE1ch \u0111\xE3 t\u1EA3i c\u1EE7a th\u01B0 m\u1EE5c hi\u1EC7n t\u1EA1i. Download tr\u1EA3 void: explorer ch\u1EC9 ghi nh\u1EADn \u0111\xE3 chuy\u1EC3n cho tr\xECnh duy\u1EC7t, kh\xF4ng gi\u1EA3 l\u1EADp ph\u1EA7n tr\u0103m.">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-khung-hep-mobile') {
        <demo-section
          ...
          [props]="[
            ...
            { name: 'c\xE2y th\u01B0 m\u1EE5c', value: 'panel m\u1EDF b\u1EB1ng n\xFAt menu' },
            { name: 'xem tr\u01B0\u1EDBc', value: 'ph\u1EE7 to\xE0n khung' }
          ]"
          note="Layout \u0111\u1ED5i theo \u0111\u1ED9 r\u1ED9ng c\u1EE7a ch\xEDnh explorer (ResizeObserver), kh\xF4ng theo viewport \u2014 \u0111\u1EB7t trong sidebar h\u1EB9p c\u0169ng t\u1EF1 chuy\u1EC3n.">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-loading-rong-va-loi') {
        <demo-section
          heading="Loading, r\u1ED7ng v\xE0 l\u1ED7i"
          [props]="[
            { name: 'list', value: 'Promise ch\u1EADm / [] / reject' },
            { name: 'th\u1EED l\u1EA1i', value: 'g\u1ECDi l\u1EA1i list' }
          ]"
          note="Th\u01B0 m\u1EE5c \u201CL\u1ED7i l\u1EA7n \u0111\u1EA7u\u201D reject \u1EDF l\u1EA7n g\u1ECDi \u0111\u1EA7u ti\xEAn; b\u1EA5m Th\u1EED l\u1EA1i (trong n\u1ED9i dung ho\u1EB7c bi\u1EC3u t\u01B0\u1EE3ng tr\xEAn c\xE2y) s\u1EBD th\xE0nh c\xF4ng.">
          <div class="frame frame--compact-height">
  ...
  styles: \`
    .frame {
      ...
      /* why: demo-section x\u1EBFp con theo flex v\xE0 co theo n\u1ED9i dung \u2014 frame ph\u1EA3i t\u1EF1 gi\xE3n h\u1EBFt b\u1EC1 ngang,
         n\u1EBFu kh\xF4ng explorer \u0111o \u0111\u01B0\u1EE3c b\u1EC1 r\u1ED9ng nh\u1ECF, v\xE0o layout compact r\u1ED3i k\u1EB9t lu\xF4n \u1EDF \u0111\xF3. */
      width: 100%;
      height: 760px;
      padding: 16px;
      border-radius: 12px;
...
export class FileExplorerDemoComponent {
  ...
  readonly states: SdFileExplorerOption = {
    autoId: 'states',
    title: 'M\xF4 ph\u1ECFng tr\u1EA1ng th\xE1i',
    list: async ({ parentId, signal }) => {
      if (parentId === null) {
        await wait(800, signal);
        return [
          { id: 'empty', parentId: null, name: 'Th\u01B0 m\u1EE5c tr\u1ED1ng', kind: 'folder', hasChildren: false },
          { id: 'slow', parentId: null, name: 'T\u1EA3i ch\u1EADm (3 gi\xE2y)', kind: 'folder', hasChildren: false },
      ...
      if (parentId === 'broken' && !this.#failedOnce) {
        ...
        throw new Error('M\xE1y ch\u1EE7 kh\xF4ng ph\u1EA3n h\u1ED3i (m\xF4 ph\u1ECFng).');
      }
      if (parentId === 'broken') {
        return [{ id: 'recovered', parentId: 'broken', name: '\u0110\xE3 kh\xF4i ph\u1EE5c.txt', kind: 'file', mimeType: 'text/plain', size: 512 }];
      }
      return [];
    },
  };
  ...
  onOpen(event: SdFileExplorerOpenEvent): void {
    ...
    this.lastOpen.set(\`\${event.item.name} \xB7 \${path}\`);
  }
}
`,scss:`.frame {
  box-sizing: border-box;
  ...
  template: \`
    <demo-page #demoPage
      ...
      <demo-section heading="Builder + Render"
        ...
        note="Group c\xF3 th\u1EC3 thu g\u1ECDn/m\u1EDF r\u1ED9ng trong preview; \u0111i\u1EC1u ki\u1EC7n v\xF4 hi\u1EC7u h\xF3a \u0111\u01B0\u1EE3c c\u1EA5u h\xECnh tr\xEAn t\u1EEBng tr\u01B0\u1EDDng con.">
...
@Component({
  ...
  template: \`
    <demo-page
      #demoPage
      title="Inform"
      description="Th\xF4ng b\xE1o trong trang v\u1EDBi icon n\u1EC1n nh\u1EB9, 6 m\xE0u tr\u1EA1ng th\xE1i, n\xFAt thao t\xE1c nh\u1ECF v\xE0 n\u1ED9i dung thu g\u1ECDn.">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-chi-co-tieu-de') {
        <demo-section
          heading="Ch\u1EC9 c\xF3 ti\xEAu \u0111\u1EC1"
          [props]="[
            { name: 'title', value: 'text' },
            { name: 'closable', value: 'true' },
          ]"
          note="Ti\xEAu \u0111\u1EC1 c\u0103n gi\u1EEFa v\u1EDBi icon k\u1EC3 c\u1EA3 khi kh\xF4ng c\xF3 m\xF4 t\u1EA3 ho\u1EB7c c\xF3 th\xEAm action.">
          <sd-inform success title="\u0110\xE3 l\u01B0u thay \u0111\u1ED5i"></sd-inform>
          <sd-inform warning closable title="Phi\xEAn l\xE0m vi\u1EC7c s\u1EAFp h\u1EBFt h\u1EA1n"></sd-inform>
          <sd-inform error closable title="Kh\xF4ng th\u1EC3 k\u1EBFt n\u1ED1i" actionLabel="Th\u1EED l\u1EA1i"></sd-inform>
        </demo-section>
      }

      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-noi-dung-tuy-bien') {
        <demo-section
          heading="N\u1ED9i dung t\xF9y bi\u1EBFn"
          [props]="[
            { name: 'ng-content', value: 'template' },
            { name: 'closable', value: 'true' },
          ]"
          note="N\u1ED9i dung truy\u1EC1n v\xE0o thay title, description v\xE0 action m\u1EB7c \u0111\u1ECBnh; icon v\xE0 n\xFAt \u0111\xF3ng v\u1EABn gi\u1EEF nguy\xEAn.">
          <sd-inform warning closable title="Ti\xEAu \u0111\u1EC1 m\u1EB7c \u0111\u1ECBnh" description="M\xF4 t\u1EA3 m\u1EB7c \u0111\u1ECBnh" actionLabel="Action m\u1EB7c \u0111\u1ECBnh">
            <strong>C\u1EA7n ki\u1EC3m tra l\u1EA1i th\xF4ng tin</strong>
            <span>C\xF3 <b>2 tr\u01B0\u1EDDng</b> ch\u01B0a ho\xE0n t\u1EA5t. B\u1EA1n c\xF3 th\u1EC3 gi\u1EEF b\u1EA3n nh\xE1p \u0111\u1EC3 x\u1EED l\xFD sau.</span>
            <button type="button" class="demo-action-btn" (click)="customActionCount = customActionCount + 1">Gi\u1EEF b\u1EA3n nh\xE1p</button>
          </sd-inform>
          <sd-inform info closable>N\u1ED9i dung ng\u1EAFn truy\u1EC1n tr\u1EF1c ti\u1EBFp, v\u1EABn c\xF3 icon v\xE0 n\xFAt \u0111\xF3ng.</sd-inform>
          <p aria-live="polite">\u0110\xE3 gi\u1EEF b\u1EA3n nh\xE1p {{ customActionCount }} l\u1EA7n.</p>
        </demo-section>
      }

      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-dong-duoc-action') {
        <demo-section
          heading="\u0110\xF3ng \u0111\u01B0\u1EE3c + action"
          [props]="[
            { name: 'closable', value: 'true' },
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-tip-mot-dong') {
        <demo-section
          heading="Tip m\u1ED9t d\xF2ng"
          [props]="[
            { name: 'type', value: 'tip' },
            { name: 'color', value: 'info' },
          ]">
          <div class="tip-examples">
            <sd-inform type="tip" color="info">B\u1EA5m Th\xEAm b\u1ED9 l\u1ECDc \u0111\u1EC3 ch\u1ECDn tr\u01B0\u1EDDng c\u1EA7n t\xECm ki\u1EBFm.</sd-inform>
          </div>
        </demo-section>
      }
        ...
        <demo-section
          ...
          <div class="tip-examples tip-narrow">
            <sd-inform
              type="tip"
              color="info"
              title="T\xECm ki\u1EBFm ch\xEDnh x\xE1c h\u01A1n"
              description="Ch\u1ECDn tr\u01B0\u1EDDng c\u1EA7n t\xECm tr\u01B0\u1EDBc khi nh\u1EADp gi\xE1 tr\u1ECB. B\u1EA1n c\xF3 th\u1EC3 k\u1EBFt h\u1EE3p nhi\u1EC1u \u0111i\u1EC1u ki\u1EC7n v\xE0 l\u01B0u b\u1ED9 l\u1ECDc \u0111\u1EC3 s\u1EED d\u1EE5ng trong l\u1EA7n truy c\u1EADp ti\u1EBFp theo."></sd-inform>
          </div>
        </demo-section>
      }
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-tip-noi-dung-phong-phu') {
        <demo-section
          heading="Tip n\u1ED9i dung phong ph\xFA"
          [props]="[
            { name: 'type', value: 'tip' },
            { name: 'ng-content', value: 'template' },
          ]"
          note="Ch\u1EEF \u0111\u1EADm, inline code, li\xEAn k\u1EBFt v\xE0 binding Angular gi\u1EEF nguy\xEAn trong c\xF9ng lu\u1ED3ng v\u0103n b\u1EA3n.">
          <div class="tip-examples">
            <sd-inform type="tip" color="info">
              B\u1EA5m <strong>{{ filterAction }}</strong> \u0111\u1EC3 ch\u1ECDn tr\u01B0\u1EDDng. B\u1EADt <code>showSavedFilters</code> \u0111\u1EC3 l\u01B0u b\u1ED9 l\u1ECDc. \u0110\xE3 ch\u1ECDn
            ...
            <button type="button" class="demo-action-btn" (click)="selectedFilters = selectedFilters + 1">Th\xEAm tr\u01B0\u1EDDng</button>
            @if (showFilterHelp) {
              <p id="tip-filter-help">Ch\u1ECDn t\xEAn tr\u01B0\u1EDDng, to\xE1n t\u1EED v\xE0 gi\xE1 tr\u1ECB r\u1ED3i b\u1EA5m T\xECm ki\u1EBFm \u0111\u1EC3 \xE1p d\u1EE5ng b\u1ED9 l\u1ECDc.</p>
            }
          </div>
        </demo-section>
      }
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-tip-bang-mau') {
        <demo-section
          heading="Tip b\u1EA3ng m\xE0u"
          [props]="[
            { name: 'type', value: 'tip' },
            { name: 'color', value: 'primary / secondary / info / success / warning / error' },
          ]"
          note="T\u1EA5t c\u1EA3 tip d\xF9ng role note, k\u1EC3 c\u1EA3 m\xE0u warning v\xE0 error.">
          <div class="tip-examples">
            <sd-inform type="tip" color="primary">Primary \u2014 ch\u1ECDn m\u1EE5c \u0111\u1EC3 xem chi ti\u1EBFt.</sd-inform>
            <sd-inform type="tip" color="secondary">Secondary \u2014 b\u1EA1n c\xF3 th\u1EC3 l\u01B0u b\u1EA3n nh\xE1p.</sd-inform>
            <sd-inform type="tip" color="info">Info \u2014 d\xF9ng b\u1ED9 l\u1ECDc \u0111\u1EC3 thu h\u1EB9p k\u1EBFt qu\u1EA3.</sd-inform>
            <sd-inform type="tip" color="success">Success \u2014 d\u1EEF li\u1EC7u h\u1EE3p l\u1EC7 c\xF3 th\u1EC3 \u0111\u01B0\u1EE3c g\u1EEDi ngay.</sd-inform>
            <sd-inform type="tip" color="warning">Warning \u2014 ki\u1EC3m tra \u0111\u1ECBnh d\u1EA1ng tr\u01B0\u1EDBc khi nh\u1EADp d\u1EEF li\u1EC7u.</sd-inform>
            <sd-inform type="tip" color="error">Error \u2014 xem h\u01B0\u1EDBng d\u1EABn x\u1EED l\xFD d\xF2ng kh\xF4ng h\u1EE3p l\u1EC7.</sd-inform>
          </div>
        </demo-section>
      }
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-tip-trong-form-va-bang') {
        <demo-section
          heading="Tip trong form v\xE0 b\u1EA3ng"
          [props]="[
            { name: 'type', value: 'tip' },
            { name: 'ng-content', value: 'template' },
          ]">
          <div class="tip-examples">
            <form class="tip-form" (submit)="$event.preventDefault()">
              <sd-input label="T\xEAn b\u1ED9 l\u1ECDc" [(model)]="filterName" placeholder="V\xED d\u1EE5: C\xF4ng vi\u1EC7c c\u1EE7a t\xF4i"></sd-input>
              <sd-inform type="tip" color="info"
                >\u0110\u1EB7t t\xEAn d\u1EC5 nh\u1EDB \u0111\u1EC3 t\xECm l\u1EA1i b\u1ED9 l\u1ECDc <strong>{{ filterName || 'c\u1EE7a b\u1EA1n' }}</strong
                >.</sd-inform
              >
            </form>
            <sd-inform type="tip" color="info">B\u1EA5m ti\xEAu \u0111\u1EC1 c\u1ED9t \u0111\u1EC3 <strong>s\u1EAFp x\u1EBFp</strong> danh s\xE1ch c\xF4ng vi\u1EC7c b\xEAn d\u01B0\u1EDBi.</sd-inform>
...
export class InformDemoComponent {
  readonly long = LONG;
  customActionCount = 0;
  readonly filterAction = 'Th\xEAm b\u1ED9 l\u1ECDc';
  selectedFilters = 0;
  ...
  readonly tipTableOption: SdTableOption<{ id: number; name: string; status: string }> = {
    ...
    rowKey: 'id',
    items: () => [
      { id: 1, name: 'Ki\u1EC3m tra d\u1EEF li\u1EC7u', status: '\u0110ang l\xE0m' },
      { id: 2, name: 'L\u01B0u b\u1ED9 l\u1ECDc', status: 'Ho\xE0n t\u1EA5t' },
    ],
    sort: { enable: true },
    columns: [
      { field: 'name', type: 'string', title: 'C\xF4ng vi\u1EC7c' },
      { field: 'status', type: 'string', title: 'Tr\u1EA1ng th\xE1i' },
    ],
  };
}
...
.tip-examples > .demo-action-btn {
  justify-self: start;
}`},"components/job-progress":{typescript:`import { ChangeDetectionStrategy, Component, DestroyRef, inject, signal } from '@angular/core';
...
@Component({
  ...
  template: \`
    <demo-page
      #demoPage
      title="Modal"
      description="Dialog va bottom-sheet dung chung slot sdHeaderLeft/sdHeaderRight/sdFooterLeft/sdFooterRight. Header, body v\xE0 footer c\xF3 l\u1EC1 th\u1EB3ng h\xE0ng, t\u1EF1 \u0111i\u1EC1u ch\u1EC9nh tr\xEAn mobile.">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-trong-container') {
        <demo-section heading="Trong container" [props]="[{ name: 'contained', value: 'true' }]">
          <sd-quick-action opened contained>
            <span sdMessage>Thanh thao t\xE1c n\u1EB1m trong v\xF9ng cu\u1ED9n c\u1EE7a b\u1EA3ng mobile.</span>
...
.badge-row {
  ...
  flex-wrap: wrap;
  gap: 6px;
}`},"components/side-drawer":{typescript:`import { ChangeDetectionStrategy, Component, signal } from '@angular/core';
import { DemoPageComponent, DemoSectionComponent } from '../../../shared/demo-page.component';
import { SdBadge } from '@sdcorejs/angular/components/badge';
import { SdButton } from '@sdcorejs/angular/components/button';
import { SdSection, SdSectionItem } from '@sdcorejs/angular/components/section';
...
@Component({
  ...
  template: \`
    <demo-page
      #demoPage
      title="Side Drawer"
      description="Right-side panel cho form/detail/filter. Header va footer dung slot sdHeaderLeft/sdHeaderRight/sdFooterLeft/sdFooterRight; n\u1ED9i dung c\xF3 l\u1EC1 th\u1ED1ng nh\u1EA5t v\xE0 h\u1ED7 tr\u1EE3 mobile.">
          ...
          <div #ordersArea class="drawer-area">
            ...
            <div class="drawer-list drawer-area__list">
              @for (order of orders; track order.code) {
                <div class="drawer-list__row">
                  <span>{{ order.code }} \xB7 {{ order.customer }}</span>
                  <sd-button
                    type="text"
                    color="primary"
                    title="Detail"
...
.bg-blue { background: var(--sd-primary-light, #d7e3ff); }
.bg-grey { background: #f5f5f5; color: #424242; }`},"components/stepper":{typescript:`import { SdButton } from '@sdcorejs/angular/components/button';
  ...
  template: \`
    <demo-page #demoPage
      ...
      <demo-section heading="Tab c\u01A1 b\u1EA3n" [props]="[{ name: 'label', value: 'text' }, { name: 'headerClass', value: 'bg-white' }, { name: 'bodyClass', value: 'p-16' }]"
        note="N\u1EC1n tr\u1EAFng ch\u1EC9 \xE1p d\u1EE5ng cho header c\u1EE7a group n\xE0y; body gi\u1EEF n\u1EC1n theme v\xE0 c\xF3 kho\u1EA3ng \u0111\u1EC7m ri\xEAng.">
        <div class="full">
      ...
      <demo-section heading="Variant pills" [props]="[{ name: 'variant', value: 'pills' }]" note="Pill n\u1EC1n light, ch\u1EEF/icon theo m\xE0u ch\u1EE7 \u0111\u1EA1o. B\u1EA5m l\u1EA1i tab active ho\u1EB7c \u0111i\u1EC1u h\u01B0\u1EDBng b\xE0n ph\xEDm \u0111\u1EC3 ki\u1EC3m tra m\xE0u ch\u1EEF \u1ED5n \u0111\u1ECBnh.">
        <div class="full">
...
const QUICK_SEARCH_CUSTOMERS: QuickSearchCustomer[] = [
  ...
  { code: 'KH-002', name: 'Tr\u1EA7n Thanh B\xECnh', phone: '0900000002', email: 'binh@example.com', tenantId: 'north' },
  { code: 'KH-003', name: 'L\xEA Ho\xE0ng An', phone: '0900000003', email: 'hoang@example.com', tenantId: 'south' },
  ...
  template: \`
    <demo-page #demoPage
      ...
      <demo-section heading="Quick search"
        ...
        note="Ch\u1ECDn tenant \xE1p d\u1EE5ng ngay; nh\u1EADp t\u1EEB kh\xF3a r\u1ED3i nh\u1EA5n Enter. T\xEAn/email t\xECm ch\u1EE9a, m\xE3/S\u0110T t\xECm ch\xEDnh x\xE1c; email kh\xF4ng c\u1EA7n c\xF3 c\u1ED9t. \u0110\u1ED5i tenant \u1EDF m\xE0n A r\u1ED3i chuy\u1EC3n m\xE0n B \u0111\u1EC3 th\u1EA5y l\u1EF1a ch\u1ECDn \u0111\u01B0\u1EE3c gi\u1EEF b\u1EB1ng signal chung. Checkbox b\xEAn ph\u1EA3i l\xE0 UI do consumer ch\xE8n v\xE0o.">
        <div class="d-flex gap-8 mb-16">
          <sd-button title="M\xE0n A" size="sm" [type]="quickScreen() === 'A' ? 'fill' : 'outline'" (click)="quickScreen.set('A')" />
          <sd-button title="M\xE0n B" size="sm" [type]="quickScreen() === 'B' ? 'fill' : 'outline'" (click)="quickScreen.set('B')" />
        </div>
      ...
      <demo-section heading="External filters"
        ...
        note="B\u1ED9 l\u1ECDc g\u1ECDn, c\xF3 kho\u1EA3ng \u0111\u1EC7m v\u1EDBi m\xE9p section. Nh\u1EADp \u0111i\u1EC1u ki\u1EC7n r\u1ED3i nh\u1EA5n T\xECm ki\u1EBFm; n\xFAt x\xF3a v\xE0 thi\u1EBFt l\u1EADp n\u1EB1m tr\xEAn header. B\u1EA3ng bo nh\u1EB9 \u1EDF c\xE1c g\xF3c ngo\xE0i, v\u1EABn cu\u1ED9n v\xE0 gi\u1EEF header c\u1ED1 \u0111\u1ECBnh.">
      ...
      <demo-section heading="Th\u1EBB mobile v\xE0 thao t\xE1c"
        ...
        note="N\xFAt Th\xEAm canh gi\u1EEFa ph\xEDa tr\xEAn card. L\u1EC1 card hai b\xEAn c\u1ED1 \u0111\u1ECBnh, checkbox nh\u1ECF n\u1EB1m \u0111\xE8 g\xF3c ph\u1EA3i border. Thanh ch\u1ECDn ch\u1EEBa 16px hai \u0111\u1EA7u; nhi\u1EC1u action t\u1EF1 xu\u1ED1ng h\xE0ng \u0111\u1EC1u. Ch\u1EA1m card m\u1EDF sheet thao t\xE1c d\xF2ng; n\xFAt C\xF4ng c\u1EE5 \u1EDF footer m\u1EDF sheet t\u1EA3i l\u1EA1i, xu\u1EA5t, l\u1ECDc v\xE0 s\u1EAFp x\u1EBFp.">
        <sd-table autoId="mobile-employees" [option]="mobileOption">
          <ng-template sdTableCommandHeaderDef>
            <sd-button title="Th\xEAm" prefixIcon="add" type="text" (click)="recordMobile('Th\xEAm d\xF2ng', [])"></sd-button>
          </ng-template>
          <ng-template [sdTableRowMobileDef]="mobileOption" let-row="item" let-selected="selected" let-disabled="selectionDisabled">
            <div class="T12M text-secondary">NV-{{ row.id }} \xB7 {{ row.department }}</div>
            ...
            <a [href]="'#employee-' + row.id" (click)="recordMobile('Li\xEAn k\u1EBFt h\u1ED3 s\u01A1', [row.id]); $event.preventDefault()">H\u1ED3 s\u01A1</a>
            <sd-button title="Ghi ch\xFA" type="text" prefixIcon="edit_note" (click)="recordMobile('Ghi ch\xFA trong card', [row.id])"></sd-button>
          </ng-template>
          <ng-template sdTableExpandDef let-item="item"><div class="p-12">{{ item.data.email }} \xB7 {{ item.data.status }}</div></ng-template>
      ...
      <demo-section heading="Mobile qua nhi\u1EC1u trang"
        ...
        note="API gi\u1EA3 l\u1EADp tr\u1EA3 object m\u1EDBi sau m\u1ED7i request. Ch\u1ECDn \u1EDF trang 1 r\u1ED3i sang trang 2; summary v\xE0 callback gi\u1EEF to\xE0n b\u1ED9 selection.">
        <sd-table autoId="mobile-server" [option]="mobileServerOption">
          <ng-template [sdTableRowMobileDef]="mobileServerOption" let-row="item">
            <strong class="T16M">NV-{{ row.id }} \xB7 {{ row.name }}</strong>
            <div class="T14R mt-8">{{ row.department }} \xB7 {{ row.salary | number }} \u20AB</div>
          </ng-template>
        </sd-table>
      ...
      <demo-section heading="Mobile ch\u1ECDn d\u1EEF li\u1EC7u"
        ...
        note="Ba table \u0111\u1ED9c l\u1EADp: ch\u1ECDn \u0111\u01A1n c\xF3 m\u1EB7c \u0111\u1ECBnh; ch\u1ECDn nhi\u1EC1u kh\xF4ng c\xF3 bulk action; ch\u1EC9 c\xF3 l\u1EC7nh d\xF2ng.">
        ...
        <sd-table class="mt-16" autoId="mobile-commands-only" [option]="mobileCommandsOnlyOption">
          <ng-template [sdTableRowMobileDef]="mobileCommandsOnlyOption" let-row="item"><strong>{{ row.name }}</strong><div>Ch\u1EC9 thao t\xE1c theo d\xF2ng</div></ng-template>
        </sd-table>
      </demo-section>
      }
      ...
      <demo-section heading="Mobile trong h\u1ED9p tho\u1EA1i"
        ...
        note="Card v\xE0 thanh thao t\xE1c n\u1EB1m trong v\xF9ng cu\u1ED9n c\u1EE7a t\u1EEBng table. \u0110\xF3ng h\u1ED9p tho\u1EA1i ho\u1EB7c drawer s\u1EBD d\u1ECDn c\xE1c overlay con.">
        ...
        <sd-modal #mobileModal title="Nh\xE2n vi\xEAn trong modal" width="md">
        ...
        <sd-side-drawer #mobileDrawer title="Nh\xE2n vi\xEAn trong drawer" width="480px">
      ...
      <demo-section heading="D\xF2ng m\u1EDF r\u1ED9ng" [props]="[{ name: 'expand', value: 'true' }, { name: 'sdTableExpandDef', value: 'template' }]">
        <div class="table-box">
          <sd-table [option]="expandOption">
            <ng-template [sdTableRowMobileDef]="expandOption" let-row="item"><strong>{{ row.title }}</strong><div>{{ row.assignee }} \xB7 {{ row.progress }}%</div></ng-template>
      ...
      <demo-section heading="L\u1EC7nh d\xF2ng ph\u1EA3i"
        [props]="[{ name: 'command.align', value: 'right' }, { name: 'command.commands[].disabled', value: '(row) => boolean' }]"
        note="SP-003 minh h\u1ECDa l\u1EC7nh S\u1EEDa v\xE0 X\xF3a b\u1ECB v\xF4 hi\u1EC7u h\xF3a: icon nh\u1EA1t m\xE0u, l\u1EC7nh Xem v\u1EABn s\u1EED d\u1EE5ng \u0111\u01B0\u1EE3c.">
        <div class="table-box">
      ...
      <demo-section
        ...
        note="Command v\xE0 action children d\xF9ng menu g\u1ECDn n\u1EC1n tr\u1EAFng. Ch\u1ECDn d\xF2ng \u0111\u1EC3 th\u1EED action nh\xF3m; c\xE1c child command v\u1EABn h\u1ED7 tr\u1EE3 icon, title, color, disabled, hidden v\xE0 click theo t\u1EEBng row.">
        <div class="table-box">
      ...
      <demo-section
        heading="Action \u0111\xE3 ch\u1ECDn c\xF3 menu con"
        [props]="[
          { name: 'selector.actions[].children', value: 'menu' },
          { name: 'selector.defaultSelected', value: 'callback' }
        ]"
        note="M\u1ED9t d\xF2ng \u0111\u01B0\u1EE3c ch\u1ECDn s\u1EB5n. M\u1EDF X\u1EED l\xFD \u0111\xE3 ch\u1ECDn \u1EDF thanh d\u01B0\u1EDBi b\u1EA3ng \u0111\u1EC3 th\u1EED menu con; ch\u1ECDn th\xEAm d\xF2ng \u0111\u1EC3 ki\u1EC3m tra danh s\xE1ch truy\u1EC1n v\xE0o callback.">
        <div class="table-box">
      ...
      <demo-section heading="Column aggregate" [props]="[{ name: 'column.aggregate', value: 'built-in / callback / template' }]"
        ...
        note="T\u1ED5ng \u0111\u1ED9c l\u1EADp ph\xEDa tr\xEAn footer: local page/filtered, COUNT, grouped headers, row groups, tree v\xE0 lazy children. Server filtered kh\xF4ng \u0111\u01B0\u1EE3c h\u1ED7 tr\u1EE3; ch\u1EC9 t\xEDnh page ho\u1EB7c t\u1EF1 cung c\u1EA5p nghi\u1EC7p v\u1EE5 t\u1ED5ng b\xEAn ngo\xE0i table.">
...
export class TableDemoComponent {
  ...
  readonly quickSearchLog = signal('Tenant d\xF9ng chung: Mi\u1EC1n B\u1EAFc. D\u1EEF li\u1EC7u minh h\u1ECDa.');
  ...
  private createQuickSearchOption(screen: 'A' | 'B'): SdTableOption<QuickSearchCustomer> {
    ...
    filter: { key: \`demo-quick-search-\${screen}\`, cacheable: true, quickSearch: {
      ...
      placeholder: 'T\xEAn, email, m\xE3 KH ho\u1EB7c s\u1ED1 \u0111i\u1EC7n tho\u1EA1i\u2026',
      filters: [{
        ...
        onChange: value => {
          ...
          this.quickSearchLog.set(\`M\xE0n \${screen} \u0111\xE3 ch\u1ECDn tenant: \${value || '(ch\u01B0a ch\u1ECDn)'}. M\xE0n c\xF2n l\u1EA1i s\u1EBD d\xF9ng l\u1EF1a ch\u1ECDn n\xE0y.\`);
        },
      }],
    } },
    columns: [
      { field: 'code', title: 'M\xE3 KH', type: 'string', width: '120px' },
      { field: 'name', title: 'Kh\xE1ch h\xE0ng', type: 'string', width: '240px' },
  ...
  readonly externalFilterOption: SdTableOption<Employee> = {
    ...
    items: async ({ rawExternalFilter, pageNumber, pageSize }) => {
      // Mock API: consumer x\u1EED l\xFD external filters t\u1EEB request c\u1EE7a table.
    ...
    filter: {
      ...
      externalFilters: [
        { field: 'name', title: 'H\u1ECD v\xE0 t\xEAn', type: 'string', defaultShowing: true },
        { field: 'department', title: 'Ph\xF2ng ban', type: 'values', defaultShowing: true,
          option: { valueField: 'value', displayField: 'display', items: [
            { value: 'TECH', display: 'C\xF4ng ngh\u1EC7' }, { value: 'SALES', display: 'Kinh doanh' },
            { value: 'HR', display: 'Nh\xE2n s\u1EF1' }, { value: 'FINANCE', display: 'T\xE0i ch\xEDnh' },
            { value: 'MARKETING', display: 'Marketing' },
          ] } },
        { field: 'salary', title: 'L\u01B0\u01A1ng', type: 'number', defaultShowing: true },
        { field: 'joinDate', title: 'Ng\xE0y v\xE0o l\xE0m', type: 'daterange', defaultShowing: true },
      ],
    },
    columns: [
      { field: 'name', title: 'H\u1ECD v\xE0 t\xEAn', type: 'string', width: '220px', fixed: true },
      { field: 'department', title: 'Ph\xF2ng ban', type: 'string', width: '180px' },
      { field: 'position', title: 'Ch\u1EE9c v\u1EE5', type: 'string', width: '220px' },
      { field: 'salary', title: 'L\u01B0\u01A1ng', type: 'number', width: '180px' },
      { field: 'joinDate', title: 'Ng\xE0y v\xE0o l\xE0m', type: 'date', width: '180px' },
    ],
  ...
  readonly commandRightOption: SdTableOption<Product> = {
    ...
    command: {
      ...
      commands: [
        ...
        { icon: 'delete', title: 'X\xF3a', color: 'error', disabled: (p: Product) => !p.active, click: (p: Product) => alert(\`X\xF3a \${p.code}\`) },
      ],
    },
    columns: [
  ...
  readonly commandChildrenEvent = signal('M\u1EDF Thao t\xE1c th\xEAm tr\xEAn m\u1ED9t d\xF2ng \u0111\u1EC3 th\u1EED menu con.');
  ...
  readonly commandChildrenOption: SdTableOption<Product> = {
    ...
    selector: {
      visible: true,
      actions: [{
        title: 'X\u1EED l\xFD \u0111\xE3 ch\u1ECDn', icon: 'checklist', children: [
          { title: 'Ki\u1EC3m kho', icon: 'inventory_2', click: rows => this.commandChildrenEvent.set('Ki\u1EC3m kho ' + rows?.length + ' s\u1EA3n ph\u1EA9m') },
          { title: 'X\xF3a', icon: 'delete', color: 'error', click: rows => this.commandChildrenEvent.set('X\xF3a ' + rows?.length + ' s\u1EA3n ph\u1EA9m') },
        ],
      }],
    },
    command: {
      ...
      commands: [
        { icon: 'visibility', title: 'Xem nhanh', click: (p: Product) => this.commandChildrenEvent.set(\`Xem nhanh \${p.code}\`) },
        {
          ...
          children: [
            { icon: 'content_copy', title: 'Nh\xE2n b\u1EA3n', click: (p: Product) => this.commandChildrenEvent.set(\`Nh\xE2n b\u1EA3n \${p.code}\`) },
            {
              icon: 'inventory_2',
              title: 'Ki\u1EC3m kho',
            ...
            },
            {
              ...
              click: (p: Product) => this.commandChildrenEvent.set(\`Ng\u1EEBng b\xE1n \${p.code}\`),
            },
            { icon: 'delete', title: 'X\xF3a', color: 'error', click: (p: Product) => this.commandChildrenEvent.set(\`X\xF3a \${p.code}\`) },
          ],
        },
      ],
    },
  ...
  readonly actionChildrenEvent = signal('M\u1EDF X\u1EED l\xFD \u0111\xE3 ch\u1ECDn \u0111\u1EC3 th\u1EED action c\xF3 children.');
  readonly actionChildrenOption: SdTableOption<Product> = {
    ...
    selector: {
      ...
      message: rows => \`\u0110\xE3 ch\u1ECDn \${rows?.length ?? 0} s\u1EA3n ph\u1EA9m\`,
      actions: [{
        title: 'X\u1EED l\xFD \u0111\xE3 ch\u1ECDn', icon: 'checklist', children: [
          { title: 'Ki\u1EC3m kho', icon: 'inventory_2', click: rows => this.actionChildrenEvent.set('Ki\u1EC3m kho: ' + rows?.map(row => row.code).join(', ')) },
          { title: 'Xu\u1EA5t danh s\xE1ch', icon: 'download', click: rows => this.actionChildrenEvent.set('Xu\u1EA5t danh s\xE1ch: ' + rows?.map(row => row.code).join(', ')) },
        ],
      }],
    },
  };
  ...
  readonly mobileLog = signal('Ch\u01B0a c\xF3 thao t\xE1c.');
  readonly mobileOption: SdTableOption<Employee> = {
    type: 'local', rowKey: 'id', items: () => EMPLOYEES,
    mobile: { rowLabel: row => \`NV-\${row.id} \xB7 \${row.name}\` },
    ...
    selector: {
      ...
      actions: [
        ...
        { title: 'G\u1EAFn nh\xE3n', icon: 'label', click: rows => this.recordMobile('G\u1EAFn nh\xE3n selection', rows?.map(row => row.id) ?? []) },
        { title: 'B\xE1o c\xE1o', icon: 'folder', children: [
          { title: 'T\u1ED5ng h\u1EE3p theo ph\xF2ng ban', icon: 'summarize', click: rows => this.recordMobile('B\xE1o c\xE1o ph\xF2ng ban', rows?.map(row => row.id) ?? []) },
          { title: '\u0110\u1ED1i chi\u1EBFu d\u1EEF li\u1EC7u nh\xE2n vi\xEAn \u0111\xE3 ch\u1ECDn', icon: 'compare', click: rows => this.recordMobile('\u0110\u1ED1i chi\u1EBFu', rows?.map(row => row.id) ?? []) },
        ] },
      ],
    },
    command: { commands: [
      { title: 'Xem', icon: 'visibility', click: row => this.recordMobile('Xem d\xF2ng', [row.id]) },
      { title: 'Duy\u1EC7t', icon: 'check', color: 'success', disabled: row => row.id === 2, click: row => this.recordMobile('Duy\u1EC7t d\xF2ng', [row.id]) },
      { title: 'H\u1ED3 s\u01A1', icon: 'folder', children: [
        { title: 'L\u1ECBch s\u1EED \u0111i\u1EC1u chuy\u1EC3n v\xE0 thay \u0111\u1ED5i ch\u1EE9c v\u1EE5', icon: 'history', click: row => this.recordMobile('L\u1ECBch s\u1EED', [row.id]) },
        { title: 'H\u1EE3p \u0111\u1ED3ng', icon: 'description', disabled: row => !row.active, click: row => this.recordMobile('H\u1EE3p \u0111\u1ED3ng', [row.id]) },
      ] },
      { title: 'L\u1EC7nh c\xF3 \u0111i\u1EC1u ki\u1EC7n b\u1EA5t \u0111\u1ED3ng b\u1ED9', icon: 'schedule', hidden: async row => row.id !== 1, click: row => this.recordMobile('L\u1EC7nh async', [row.id]) },
    ] },
    columns: [
      { field: 'name', title: 'H\u1ECD t\xEAn', type: 'string', sortable: true },
...
.filter-change-log__label {
  color: #6b7280;
  font-weight: 600;
}`},"components/table/example-column-aggregate":{typescript:`import { ChangeDetectionStrategy, Component, TemplateRef, computed, signal, viewChild } from '@angular/core';
import { DecimalPipe } from '@angular/common';
import { SdButton } from '@sdcorejs/angular/components/button';
import {
  SdTable,
...
export class TableAggregateDemoComponent {
  ...
  readonly option = computed<SdTableOption<AggregateRecord> | undefined>(() => {
    ...
    return {
      ...
      columns: [
        { field: 'name', type: 'string', title: 'T\xEAn', width: '200px', aggregate: { templateRef: label } },
        { field: 'code', type: 'string', title: 'M\xE3 (COUNT)', aggregate: 'COUNT' },
        {
          field: 'money',
          type: 'children',
          title: 'S\u1ED1 li\u1EC7u',
          children: [
            ...
            { field: 'average', type: 'number', title: 'B\xECnh qu\xE2n', aggregate: 'AVERAGE' },
          ],
        },
        ...
        { field: 'date', type: 'date', title: 'Ng\xE0y (MIN)', aggregate: 'MIN' },
    ...
    columns: [
      {
        ...
        title: 'Nh\xE1nh',
        type: 'string',
        aggregate: (items, context) => (context.kind === 'tree' ? \`Nh\xE1nh \${context.parent?.name}\` : \`\${items.length} node\`),
      },
    ...
    columns: [
      {
        ...
        title: 'Nh\xE1nh lazy',
        type: 'string',
        aggregate: (items, context) => (context.isComplete ? \`\${items.length} node l\xE1\` : 'Ch\u01B0a \u0111\u1EE7 d\u1EEF li\u1EC7u'),
      },
      { field: 'amount', title: 'S\u1ED1 ti\u1EC1n', type: 'number', aggregate: 'SUM' },
    ],
    tree: {
...
}`},"components/upload-file":{typescript:`import { SdButton } from '@sdcorejs/angular/components/button';
  ...
  template: \`
    <demo-page
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-tai-nhieu-anh-co-gioi-han') {
        <demo-section
          heading="T\u1EA3i nhi\u1EC1u \u1EA3nh c\xF3 gi\u1EDBi h\u1EA1n"
          [props]="[
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-vo-hieu-hoa-chi-doc') {
        <demo-section heading="V\xF4 hi\u1EC7u h\xF3a (ch\u1EC9 \u0111\u1ECDc)" [props]="[{ name: 'disabled', value: 'true' }]">
          <div class="control-box">
            <sd-upload-file label="\u0110\xE3 \u0111\xEDnh k\xE8m" type="file" [disabled]="true" [model]="['demo-file-id']"> </sd-upload-file>
          </div>
        </demo-section>
      }
    </demo-page>
...
@Component({
  ...
  template: \`
    <demo-page
      #demoPage
      title="Checkbox"
      description="sd-checkbox \u2013 \xF4 \u0111\xE1nh d\u1EA5u. H\u1ED7 tr\u1EE3 bind hai chi\u1EC1u boolean, c\xE1c m\xE0u ch\u1EE7 \u0111\u1EC1, disabled / viewed.">
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-co-ban') {
        <demo-section
          heading="C\u01A1 b\u1EA3n"
          [props]="[{ name: '[(model)]', value: 'two-way' }]"
          note="Bind [(model)] v\u1EDBi boolean \u2014 hi\u1EC3n th\u1ECB gi\xE1 tr\u1ECB b\xEAn d\u01B0\u1EDBi.">
          <div style="display:flex; flex-direction:column; gap:8px; width:100%">
            <sd-checkbox label="T\xF4i \u0111\u1ED3ng \xFD \u0111i\u1EC1u kho\u1EA3n" [(model)]="accept" [form]="form"></sd-checkbox>
            <div style="font-size:12px; color:#555">
              Gi\xE1 tr\u1ECB: <b>{{ accept() ? 'TRUE' : 'FALSE' }}</b>
            </div>
          </div>
        </demo-section>
      }
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-kich-thuoc') {
        <demo-section
          heading="K\xEDch th\u01B0\u1EDBc"
          [props]="[{ name: 'size', value: 'sm / md / lg' }]"
          note="C\xF9ng k\xEDch th\u01B0\u1EDBc ch\u1EEF; \xF4 ch\u1ECDn v\xE0 kho\u1EA3ng c\xE1ch nh\xE3n thay \u0111\u1ED5i theo size. md l\xE0 m\u1EB7c \u0111\u1ECBnh.">
          <div style="display:flex; gap:16px; flex-wrap:wrap; align-items:center">
            <sd-checkbox size="sm" label="Small" [(model)]="small"></sd-checkbox>
            <sd-checkbox size="md" label="Medium" [(model)]="medium"></sd-checkbox>
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-mau-sac') {
        <demo-section
          ...
          note="Thu\u1ED9c t\xEDnh color thay \u0111\u1ED5i accent.">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-bao-loi-inlineerror') {
        <demo-section
          ...
          <div style="display:flex; flex-direction:column; gap:8px; width:100%">
            <sd-checkbox
              label="T\xF4i \u0111\u1ED3ng \xFD \u0111i\u1EC1u kho\u1EA3n"
              [(model)]="errAccept"
              [form]="formErr"
              [inlineError]="'B\u1EA1n ph\u1EA3i \u0111\u1ED3ng \xFD \u0111i\u1EC1u kho\u1EA3n'"></sd-checkbox>
            <div style="display:flex; gap:8px">
              <button type="button" (click)="showErr()">Hi\u1EC7n l\u1ED7i</button>
              <button type="button" (click)="resetErr()">\u0110\u1EB7t l\u1EA1i</button>
            </div>
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-che-do-xem') {
        <demo-section
          ...
          [props]="[
            { name: 'viewed', value: 'true' },
            { name: 'viewed', value: 'inline' },
          ]"
          note="viewed=true hi\u1EC7n ch\u1EEF C\xF3/Kh\xF4ng; 'inline' v\u1EABn b\u1EA5m \u0111\u01B0\u1EE3c, disabled+inline th\xEC xem t\u0129nh.">
          <div style="display:flex; gap:16px; flex-wrap:wrap">
    ...
    <demo-page
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-kich-thuoc') {
        <demo-section
          ...
          note="Label, tooltip v\xE0 d\u1EA5u b\u1EAFt bu\u1ED9c c\xF9ng h\xE0ng \u1EDF size sm, k\u1EC3 c\u1EA3 khi c\xF3 l\u1ED7i.">
          <div style="width: 320px; max-width: 100%; display: grid; gap: 16px">
            ...
            <sd-input size="sm" label="H\u1ECD v\xE0 t\xEAn" helperText="Nh\u1EADp h\u1ECD v\xE0 t\xEAn \u0111\u1EA7y \u0111\u1EE7" required inlineError="Vui l\xF2ng nh\u1EADp th\xF4ng tin"></sd-input>
...
@Component({
  ...
  template: \`
    <demo-page #demoPage title="Switch" description="sd-switch \u2013 c\xF4ng t\u1EAFc b\u1EADt/t\u1EAFt boolean. Ba k\xEDch th\u01B0\u1EDBc, m\xE0u ch\u1EE7 \u0111\u1EC1, disabled / viewed.">
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-co-ban') {
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-kich-thuoc') {
      <demo-section heading="K\xEDch th\u01B0\u1EDBc" [props]="[{ name: 'size', value: 'sm / md / lg' }]" note="M\u1EB7c \u0111\u1ECBnh md. Track l\u1EA7n l\u01B0\u1EE3t 36\xD720px, 52\xD732px v\xE0 60\xD736px.">
        <div style="display:flex; flex-wrap:wrap; align-items:center; gap:24px">
          <div style="display:flex; flex-direction:column; gap:12px">
            <sd-switch size="sm" label="sm \xB7 B\u1EADt" [model]="true" />
            <sd-switch size="sm" label="sm \xB7 T\u1EAFt" [model]="false" />
          </div>
          <div style="display:flex; flex-direction:column; gap:12px">
            <sd-switch size="md" label="md \xB7 B\u1EADt" [model]="true" />
            <sd-switch size="md" label="md \xB7 T\u1EAFt" [model]="false" />
          </div>
          <div style="display:flex; flex-direction:column; gap:12px">
            <sd-switch size="lg" label="lg \xB7 B\u1EADt" [model]="true" />
            <sd-switch size="lg" label="lg \xB7 T\u1EAFt" [model]="false" />
          </div>
        </div>
      </demo-section>
      }
      ...
      <demo-section heading="B\xEAn trong b\u1EA3ng" [props]="[{ name: 'sdTableCellDef', value: 'template' }]" note="Switch trong sd-table t\u1EF1 hi\u1EC3n th\u1ECB c\u1EE1 sm, k\u1EC3 c\u1EA3 khi cell template kh\xF4ng truy\u1EC1n size.">
...
export class SwitchDemoComponent {
  readonly switchRows = [
    { id: 1, name: 'Th\xF4ng b\xE1o email', active: true },
  ...
  readonly switchTable: SdTableOption<(typeof this.switchRows)[number]> = {
    ...
    columns: [
      { field: 'name', title: 'T\xEDnh n\u0103ng', type: 'string' },
      { field: 'active', title: 'Tr\u1EA1ng th\xE1i', type: 'boolean' },
    ],
  };
    ...
    <demo-page
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-sidebar-v3-collapsible') {
        <demo-section
          ...
          note="B\u1EA5m t\u1EEBng nh\xF3m menu \u0111\u1EC3 \u0111\xF3ng/m\u1EDF c\xE1c m\u1EE5c con tr\xEAn desktop. T\xECm ki\u1EBFm v\u1EABn th\u1EA5y m\u1EE5c trong nh\xF3m \u0111\xE3 \u0111\xF3ng; thu g\u1ECDn c\u1EA3 sidebar gi\u1EEF tr\u1EA1ng th\xE1i t\u1EEBng nh\xF3m."
          [props]="[
...
@Component({
  ...
  template: \`
    <demo-page
      #demoPage
      title="Confirm"
      description="SdConfirmService \u2013 m\u1EDF h\u1ED9p tho\u1EA1i x\xE1c nh\u1EADn tr\u1EA3 v\u1EC1 Promise. H\u1ED7 tr\u1EE3 confirm c\u01A1 b\u1EA3n, nh\u1EADp input, ch\u1ECDn radio/select, ch\u1ECDn ng\xE0y v\xE0 ng\xE0y gi\u1EDD.">
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-xac-nhan-co-ban') {
        <demo-section
          heading="X\xE1c nh\u1EADn c\u01A1 b\u1EA3n"
          [props]="[
            { name: 'confirm()', value: 'method' },
            { name: 'icon', value: 'default / info_outline' },
          ]"
          note="Kh\xF4ng truy\u1EC1n icon s\u1EBD d\xF9ng icon m\u1EB7c \u0111\u1ECBnh. Truy\u1EC1n icon \u0111\u1EC3 thay bi\u1EC3u t\u01B0\u1EE3ng trong c\xF9ng \xF4 n\u1EC1n nh\u1EB9.">
          <button mat-flat-button color="primary" (click)="onBasic()">X\xE1c nh\u1EADn thao t\xE1c</button>
          <button mat-stroked-button color="primary" (click)="onCustomIcon()">Icon t\xF9y ch\u1EC9nh</button>
        </demo-section>
      }

      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-xac-nhan-xoa') {
        <demo-section
          heading="X\xE1c nh\u1EADn x\xF3a"
          [props]="[{ name: 'confirm()', value: 'method' }]"
          note="T\xF9y ch\u1EC9nh ti\xEAu \u0111\u1EC1, nh\xE3n n\xFAt v\xE0 m\xE0u n\xFAt.">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-nhap-ly-do') {
        <demo-section
          heading="Nh\u1EADp l\xFD do"
          [props]="[{ name: 'withInput()', value: 'method' }]"
          note="withInput() \u2013 y\xEAu c\u1EA7u nh\u1EADp n\u1ED9i dung tr\u01B0\u1EDBc khi x\xE1c nh\u1EADn.">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-chon-muc-do') {
        <demo-section
          ...
          note="withRadio() \u2013 ch\u1ECDn t\u1EEB danh s\xE1ch radio.">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-chon-radio-dang-doc') {
        <demo-section
          ...
          note="withRadio(..., { display: 'column' }) \u2013 hi\u1EC3n th\u1ECB danh s\xE1ch radio theo chi\u1EC1u d\u1ECDc.">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-chon-phong-ban') {
        <demo-section
          heading="Ch\u1ECDn ph\xF2ng ban"
          [props]="[{ name: 'withSelect()', value: 'method' }]"
          note="withSelect() \u2013 ch\u1ECDn m\u1ED9t gi\xE1 tr\u1ECB b\u1EB1ng sd-select.">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-chon-ngay') {
        <demo-section
          heading="Ch\u1ECDn ng\xE0y"
          [props]="[{ name: 'withDate()', value: 'method' }]"
          note="withDate() \u2013 ch\u1ECDn ng\xE0y v\u1EDBi min/max n\u1EBFu c\u1EA7n.">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-chon-ngay-gio') {
        <demo-section
          heading="Ch\u1ECDn ng\xE0y gi\u1EDD"
          [props]="[{ name: 'withDatetime()', value: 'method' }]"
          note="withDatetime() \u2013 ch\u1ECDn ng\xE0y v\xE0 gi\u1EDD.">
...
export class ConfirmDemoComponent {
  ...
  onBasic() {
    this.#confirm
      .confirm('B\u1EA1n c\xF3 ch\u1EAFc mu\u1ED1n th\u1EF1c hi\u1EC7n thao t\xE1c n\xE0y?', { title: 'Ti\u1EBFp t\u1EE5c thao t\xE1c?', yesTitle: 'Ti\u1EBFp t\u1EE5c', noTitle: 'H\u1EE7y' })
      .then(
  ...
  onCustomIcon() {
    this.#confirm
      .confirm('Ki\u1EC3m tra l\u1EA1i th\xF4ng tin tr\u01B0\u1EDBc khi ti\u1EBFp t\u1EE5c.', {
        icon: 'info_outline',
        title: 'X\xE1c nh\u1EADn th\xF4ng tin',
        yesTitle: 'Ti\u1EBFp t\u1EE5c',
        noTitle: 'H\u1EE7y',
      })
      .then(
        () => this.log.set('Icon t\xF9y ch\u1EC9nh: \u0110\u1ED2NG \xDD'),
        () => this.log.set('Icon t\xF9y ch\u1EC9nh: H\u1EE6Y')
      );
  }

  onDelete() {
    this.#confirm
      .confirm('B\u1EA3n ghi s\u1EBD b\u1ECB x\xF3a v\u0129nh vi\u1EC5n. B\u1EA1n kh\xF4ng th\u1EC3 ho\xE0n t\xE1c thao t\xE1c n\xE0y.', {
        title: 'X\xF3a b\u1EA3n ghi n\xE0y?',
        yesTitle: 'X\xF3a b\u1EA3n ghi',
        noTitle: 'H\u1EE7y',
  ...
  onInput() {
    this.#confirm
      .withInput('Cho ng\u01B0\u1EDDi g\u1EEDi bi\u1EBFt l\xFD do \u0111\u1EC3 h\u1ECD c\xF3 th\u1EC3 \u0111i\u1EC1u ch\u1EC9nh.', {
        title: 'L\xFD do t\u1EEB ch\u1ED1i',
        label: 'L\xFD do',
        placeholder: 'Nh\u1EADp l\xFD do t\u1EEB ch\u1ED1i\u2026',
        yesTitle: 'G\u1EEDi l\xFD do',
        noTitle: 'H\u1EE7y',
        required: true,
        maxlength: 200,
      })
...
.breakpoint-list code {
  ...
  background: #f7f9fb;
    ...
    <div class="row">
    ...
    </demo-section>`}),"components/badge/example-icon-va-noi-dung-dai":t(e({},o["components/badge"]),{html:`<demo-section
      heading="Icon v\xE0 n\u1ED9i dung d\xE0i"
      [props]="[
        { name: 'type', value: 'icon' },
        { name: 'size', value: 'sm / md / lg' },
      ...
      <sd-badge type="icon" success icon="check_circle" title="title" description="description"></sd-badge>
      <sd-badge type="tag" primary icon="star" title="title" description="description"></sd-badge>
    </demo-section>`}),"components/badge/example-kich-thuoc-round":t(e({},o["components/badge"]),{html:`<demo-section
      heading="K\xEDch th\u01B0\u1EDBc round"
      [props]="[
        { name: 'type', value: 'round' },
        { name: 'size', value: 'sm / md / lg' },
      ...
      <sd-badge type="round" primary title="md" size="md"></sd-badge>
      <sd-badge type="round" primary title="lg" size="lg"></sd-badge>
    </demo-section>`}),"components/badge/example-kich-thuoc-tag":t(e({},o["components/badge"]),{html:`<demo-section
      heading="K\xEDch th\u01B0\u1EDBc tag"
      [props]="[
        { name: 'type', value: 'tag' },
        { name: 'size', value: 'sm / md / lg' },
      ...
      <sd-badge type="tag" info icon="label" title="md" size="md"></sd-badge>
      <sd-badge type="tag" info icon="label" title="lg" size="lg"></sd-badge>
    </demo-section>`}),"components/badge/example-mau-sac-icon":t(e({},o["components/badge"]),{html:`<demo-section
      heading="M\xE0u s\u1EAFc icon"
      [props]="[
        { name: 'type', value: 'icon' },
        { name: 'color', value: 'primary / secondary / success / info / warning / error' },
      ...
      <sd-badge type="icon" warning icon="circle" title="warning"></sd-badge>
      <sd-badge type="icon" error icon="circle" title="error"></sd-badge>
    </demo-section>`}),"components/badge/example-mau-sac-round":t(e({},o["components/badge"]),{html:`<demo-section
      heading="M\xE0u s\u1EAFc round"
      [props]="[
        { name: 'type', value: 'round' },
        { name: 'color', value: 'primary / secondary / success / info / warning / error' },
      ...
      <sd-badge type="round" warning title="warning"></sd-badge>
      <sd-badge type="round" error title="error"></sd-badge>
    </demo-section>`}),"components/badge/example-mau-sac-tag":t(e({},o["components/badge"]),{html:`<demo-section
      heading="M\xE0u s\u1EAFc tag"
      [props]="[
        { name: 'type', value: 'tag' },
        { name: 'color', value: 'primary / secondary / success / info / warning / error' },
      ...
      <sd-badge type="tag" warning icon="label" title="warning"></sd-badge>
      <sd-badge type="tag" error icon="label" title="error"></sd-badge>
    </demo-section>`}),"components/badge/example-round-voi-icon":t(e({},o["components/badge"]),{html:`<demo-section
      heading="Round v\u1EDBi icon"
      [props]="[
        { name: 'type', value: 'round' },
        { name: 'icon', value: 'name' },
      ...
      <sd-badge type="round" success icon="check_circle" title="md" size="md"></sd-badge>
      <sd-badge type="round" success icon="check_circle" title="lg" size="lg"></sd-badge>
    </demo-section>`}),"components/badge/example-so-dem":t(e({},o["components/badge"]),{html:`<demo-section
      heading="S\u1ED1 \u0111\u1EBFm"
      [props]="[
        { name: 'type', value: 'round' },
        { name: 'title', value: 'number' },
      ...
      note="Kh\xF4ng truy\u1EC1n items: component \u0111\u1ECDc primary route chain c\u1EE7a ch\xEDnh trang t\xE0i li\u1EC7u n\xE0y v\xE0 c\u1EADp nh\u1EADt sau NavigationEnd.">
      <sd-breadcrumb></sd-breadcrumb>
    </demo-section>`}),"components/button/example-action-popover":t(e({},o["components/button/example-action-popover"]),{html:`<div class="d-flex align-items-center gap-8 flex-wrap">
  <sd-button type="text" prefixIcon="more_vert" tooltip="Action ch\u1EC9 c\xF3 icon" autoId="popover-icon-only">
    <sd-button-item prefixIcon="edit" (click)="result.set('\u0110\xE3 ch\u1ECDn action t\u1EEB icon button')">Ch\u1EC9nh s\u1EEDa</sd-button-item>
  </sd-button>
  <sd-button openOnHover title="Hover \u0111\u1EC3 m\u1EDF" autoId="popover-hover">
    <sd-button-item prefixIcon="edit" (click)="result.set('\u0110\xE3 ch\u1ECDn action t\u1EEB menu hover')">Ch\u1EC9nh s\u1EEDa</sd-button-item>
    <sd-button-item disabled>Kh\xF4ng kh\u1EA3 d\u1EE5ng</sd-button-item>
  </sd-button>
  <sd-button title="N\xFAt th\u01B0\u1EDDng" (click)="result.set('Click n\xFAt th\u01B0\u1EDDng')" />
  <sd-button color="primary" prefixIcon="edit" autoId="popover-basic">
    Ch\u1EC9nh s\u1EEDa
    <sd-button-item prefixIcon="check" color="success" (click)="result.set('\u0110\xE3 duy\u1EC7t')">Duy\u1EC7t</sd-button-item>
    <sd-button-item prefixIcon="close" color="error" (click)="result.set('\u0110\xE3 t\u1EEB ch\u1ED1i')">T\u1EEB ch\u1ED1i</sd-button-item>
    ...
    <sd-button-item prefixIcon="delete" color="error" disabled tooltip="Ch\u01B0a \u0111\u1EE7 quy\u1EC1n">Kh\xF4ng kh\u1EA3 d\u1EE5ng</sd-button-item>
  </sd-button>
  <sd-button type="text" suffixIcon="edit" autoId="popover-dynamic" (click)="result.set('Kh\xF4ng c\xF3 item: click th\u01B0\u1EDDng')">
    Actions \u0111\u1ED9ng
    @if (showActions()) {
      <sd-button-item prefixIcon="check" color="success" (click)="result.set('Action \u0111\u1ED9ng \u0111\xE3 ch\u1EA1y')">X\xE1c nh\u1EADn</sd-button-item>
      <sd-button-item-divider />
      <sd-button-item (click)="showActions.set(false)">\u1EA8n t\u1EA5t c\u1EA3 item</sd-button-item>
    }
  </sd-button>
  <sd-button [title]="showActions() ? '\u1EA8n item' : 'Th\xEAm item'" (click)="showActions.set(!showActions())" />
</div>
<p role="status">{{ result() }}</p>`}),"components/button/example-bang-mau":t(e({},o["components/button/example-bang-mau"]),{html:`<sd-button type="fill" color="primary" title="primary"></sd-button>
...
<div class="button-toolbar" aria-label="V\xED d\u1EE5 thao t\xE1c danh s\xE1ch">
  ...
  <sd-button type="fill" color="primary" title="Th\xEAm m\u1EDBi" prefixIcon="add" autoId="toolbar-create"></sd-button>
</div>`}),"components/button/example-chi-icon":t(e({},o["components/button/example-chi-icon"]),{html:`<sd-button type="light" color="primary" prefixIcon="edit" tooltip="edit"></sd-button>
<sd-button type="light" color="error" prefixIcon="delete" tooltip="delete"></sd-button>
<sd-button type="outline" color="secondary" suffixIcon="more_vert" tooltip="Th\xEAm thao t\xE1c" autoId="suffix-only"></sd-button>`}),"components/button/example-kich-thuoc":t(e({},o["components/button/example-kich-thuoc"]),{html:`<sd-button type="fill" color="primary" size="sm" title="sm" prefixIcon="add"></sd-button>
...
<sd-button type="outline" color="secondary" title="More" suffixIcon="more_vert" [fontSet]="fontSet()"></sd-button>`}),"components/button/example-trang-thai":t(e({},o["components/button/example-trang-thai"]),{html:`<sd-button type="fill" color="primary" title="loading" prefixIcon="send" [loading]="submitting()" (click)="onSubmit()"> </sd-button>
...
<sd-button type="outline" color="secondary" title="Kh\xF4ng kh\u1EA3 d\u1EE5ng" prefixIcon="download" disabled autoId="disabled-outline"></sd-button>
<div style="display: flex; align-items: center; gap: 16px">
  <span>Icon secondary:</span>
  <sd-button type="text" color="secondary" prefixIcon="delete" tooltip="C\xF3 th\u1EC3 x\xF3a" autoId="secondary-icon-enabled"></sd-button>
  <sd-button
    type="text"
    color="secondary"
    prefixIcon="delete"
    tooltip="Kh\xF4ng th\u1EC3 x\xF3a"
    disabled
    autoId="secondary-icon-disabled"></sd-button>
</div>`}),"components/card/example-disabled-va-color":t(e({},o["components/card/example-disabled-va-color"]),{html:`<div class="example-stack">
  ...
  <sd-card-group
    ...
    <sd-card value="group-disabled" autoId="state-group-disabled">
      <div class="card-content"><strong>Disabled group</strong><span>Kh\xF4ng th\u1EC3 activate.</span></div>
    </sd-card>
  </sd-card-group>
...
</div>`}),"components/card/example-multiple-selection":t(e({},o["components/card/example-multiple-selection"]),{html:`<div class="example-stack">
  ...
  <p class="model-readout">Model: {{ selectedCodes() }} \xB7 sdChange: {{ lastChange() }}</p>
</div>`}),"components/card/example-object-comparewith":t(e({},o["components/card/example-object-comparewith"]),{html:`<div class="example-stack">
...
</div>`}),"components/card/example-single-selection":t(e({},o["components/card/example-single-selection"]),{html:`<div class="example-stack">
    ...
    @for (status of statuses; track status.code) {
      <sd-card #card="sdCard" [value]="status" [autoId]="'single-' + status.code">
        <div class="card-content">
          ...
          <small>{{ card.selected() ? '\u0110\xE3 ch\u1ECDn' : 'Ch\u01B0a ch\u1ECDn' }}</small>
        </div>
      </sd-card>
    }
  </sd-card-group>
  <p class="model-readout">sdChange g\u1EA7n nh\u1EA5t: {{ lastChange() }}</p>
</div>`}),"components/card/example-standalone-card":t(e({},o["components/card/example-standalone-card"]),{html:`<div class="example-stack">
  <sd-card #card="sdCard" class="demo-card" value="participating" autoId="standalone" (click)="onCardClick(card.selected())">
    <div class="card-content">
      <strong>Participation</strong>
      <span>To\xE0n b\u1ED9 n\u1ED9i dung n\xE0y do consumer project v\xE0o.</span>
      <small>{{ card.selected() ? '\u0110\xE3 ch\u1ECDn' : 'Click \u0111\u1EC3 ch\u1ECDn' }}</small>
    </div>
  </sd-card>
  <p class="model-readout">selected(): {{ lastSelected() }}</p>
</div>`}),"components/code-editor/example-che-do-xem-json":t(e({},o["components/code-editor"]),{html:`<demo-section heading="Ch\u1EBF \u0111\u1ED9 xem JSON" [props]="[{ name: 'language', value: 'json' }, { name: 'viewed', value: 'true' }]">
    <div class="code-box">
      <sd-code-editor language="json" [model]="jsonValue" [viewed]="true" maxHeight="240px"></sd-code-editor>
    </div>
    ...
    <div class="code-box">
      ...
      <sd-data-state state="loading" compact></sd-data-state>
    </demo-section>`}),"components/data-state/example-loi-va-retry-tren-ba-control":t(e({},o["components/data-state"]),{html:`<demo-section
      heading="L\u1ED7i v\xE0 retry tr\xEAn ba control"
      [props]="[{ name: 'readState / sdReadStateChange', value: 'idle \u2192 loading \u2192 ready / empty / error' }]">
      <p>
        Ban \u0111\u1EA7u m\xE1y ch\u1EE7 m\xF4 ph\u1ECFng tr\u1EA3 l\u1ED7i. Ch\u1ECDn \u201CC\xF3 d\u1EEF li\u1EC7u\u201D ho\u1EB7c \u201CR\u1ED7ng h\u1EE3p l\u1EC7\u201D, r\u1ED3i b\u1EA5m Th\u1EED l\u1EA1i tr\xEAn control. Ch\u1ECDn \u201CTi\u1EBFp t\u1EE5c l\u1ED7i\u201D \u0111\u1EC3 th\u1EED
    ...
    </demo-section>`}),"components/data-state/example-panel-hep-va-lua-chon-dang-giu":t(e({},o["components/data-state"]),{html:`<demo-section
      heading="Panel h\u1EB9p v\xE0 l\u1EF1a ch\u1ECDn \u0111ang gi\u1EEF"
      [props]="[
        { name: 'multiple', value: 'true' },
        { name: 'minWidthPanel', value: '180px' },
  ...
  </demo-section>`}),"components/file-explorer/example-chi-xem-va-tai-xuong":t(e({},o["components/file-explorer"]),{html:`<demo-section
      heading="Ch\u1EC9 xem v\xE0 t\u1EA3i xu\u1ED1ng"
      [props]="[
        { name: 'option.upload', value: 'kh\xF4ng truy\u1EC1n' },
        { name: 'option.createFolder', value: 'kh\xF4ng truy\u1EC1n' },
    ...
    </demo-section>`}),"components/file-explorer/example-day-du-tinh-nang":t(e({},o["components/file-explorer"]),{html:`<demo-section
      heading="\u0110\u1EA7y \u0111\u1EE7 t\xEDnh n\u0103ng"
      [props]="[
        { name: 'option.list', value: 'lazy theo th\u01B0 m\u1EE5c' },
        { name: 'option.search', value: 'debounce 300ms' },
    ...
    </demo-section>`}),"components/file-explorer/example-khung-hep-mobile":t(e({},o["components/file-explorer"]),{html:`<demo-section
      heading="Khung h\u1EB9p / mobile"
      [props]="[
        { name: 'width', value: '< 720px' },
        { name: 'c\xE2y th\u01B0 m\u1EE5c', value: 'panel m\u1EDF b\u1EB1ng n\xFAt menu' },
    ...
    </demo-section>`}),"components/file-explorer/example-loading-rong-va-loi":t(e({},o["components/file-explorer"]),{html:`<demo-section
      heading="Loading, r\u1ED7ng v\xE0 l\u1ED7i"
      [props]="[
        { name: 'list', value: 'Promise ch\u1EADm / [] / reject' },
        { name: 'th\u1EED l\u1EA1i', value: 'g\u1ECDi l\u1EA1i list' }
    ...
    </demo-section>`}),"components/form-generic/example-builder-render":t(e({},o["components/form-generic"]),{html:`<demo-section heading="Builder + Render"
    [props]="[{ name: 'formGeneric', value: 'SdFormGeneric' }, { name: 'properties.collapsible', value: 'true' }]"
    note="Group c\xF3 th\u1EC3 thu g\u1ECDn/m\u1EDF r\u1ED9ng trong preview; \u0111i\u1EC1u ki\u1EC7n v\xF4 hi\u1EC7u h\xF3a \u0111\u01B0\u1EE3c c\u1EA5u h\xECnh tr\xEAn t\u1EEBng tr\u01B0\u1EDDng con.">
    <div class="row-actions">
      <sd-button type="outline" color="primary" title="\u0110\u1EB7t l\u1EA1i" prefixIcon="restart_alt" (click)="reset()"></sd-button>
    ...
    <sd-import-excel [option]="employeeImport" #excelModalRef></sd-import-excel>
      ...
      <sd-inform warning title="warning" description="Message body."></sd-inform>
      <sd-inform error title="error" description="Message body."></sd-inform>
    </demo-section>`}),"components/inform/example-chi-co-tieu-de":t(e({},o["components/inform"]),{html:`<demo-section
      heading="Ch\u1EC9 c\xF3 ti\xEAu \u0111\u1EC1"
      [props]="[
        { name: 'title', value: 'text' },
        { name: 'closable', value: 'true' },
      ...
      <sd-inform warning closable title="Phi\xEAn l\xE0m vi\u1EC7c s\u1EAFp h\u1EBFt h\u1EA1n"></sd-inform>
      <sd-inform error closable title="Kh\xF4ng th\u1EC3 k\u1EBFt n\u1ED1i" actionLabel="Th\u1EED l\u1EA1i"></sd-inform>
    </demo-section>`}),"components/inform/example-dong-duoc-action":t(e({},o["components/inform"]),{html:`<demo-section
      heading="\u0110\xF3ng \u0111\u01B0\u1EE3c + action"
      [props]="[
        { name: 'closable', value: 'true' },
        { name: 'actionLabel', value: 'text' },
      ...
      <sd-inform info title="\u0110i\u1EC1u kho\u1EA3n" [description]="long" [lineClamp]="3"></sd-inform>
      <sd-inform success [description]="long" [lineClamp]="2"></sd-inform>
    </demo-section>`}),"components/inform/example-noi-dung-tuy-bien":t(e({},o["components/inform"]),{html:`<demo-section
      heading="N\u1ED9i dung t\xF9y bi\u1EBFn"
      [props]="[
        { name: 'ng-content', value: 'template' },
        { name: 'closable', value: 'true' },
      ...
      <sd-inform info closable>N\u1ED9i dung ng\u1EAFn truy\u1EC1n tr\u1EF1c ti\u1EBFp, v\u1EABn c\xF3 icon v\xE0 n\xFAt \u0111\xF3ng.</sd-inform>
      <p aria-live="polite">\u0110\xE3 gi\u1EEF b\u1EA3n nh\xE1p {{ customActionCount }} l\u1EA7n.</p>
    </demo-section>`}),"components/inform/example-tip-bang-mau":t(e({},o["components/inform"]),{html:`<demo-section
      heading="Tip b\u1EA3ng m\xE0u"
      [props]="[
        { name: 'type', value: 'tip' },
        { name: 'color', value: 'primary / secondary / info / success / warning / error' },
    ...
    </demo-section>`}),"components/inform/example-tip-co-tieu-de":t(e({},o["components/inform"]),{html:`<demo-section
      heading="Tip c\xF3 ti\xEAu \u0111\u1EC1"
      [props]="[
        { name: 'type', value: 'tip' },
        { name: 'title', value: 'text' },
    ...
    </demo-section>`}),"components/inform/example-tip-mot-dong":t(e({},o["components/inform"]),{html:`<demo-section
      heading="Tip m\u1ED9t d\xF2ng"
      [props]="[
        { name: 'type', value: 'tip' },
        { name: 'color', value: 'info' },
    ...
    </demo-section>`}),"components/inform/example-tip-noi-dung-phong-phu":t(e({},o["components/inform"]),{html:`<demo-section
      heading="Tip n\u1ED9i dung phong ph\xFA"
      [props]="[
        { name: 'type', value: 'tip' },
        { name: 'ng-content', value: 'template' },
    ...
    </demo-section>`}),"components/inform/example-tip-trong-form-va-bang":t(e({},o["components/inform"]),{html:`<demo-section
      heading="Tip trong form v\xE0 b\u1EA3ng"
      [props]="[
        { name: 'type', value: 'tip' },
        { name: 'ng-content', value: 'template' },
  ...
  </demo-section>`}),"components/modal/example-basic-modal-footer-right":t(e({},o["components/modal"]),{html:`<demo-section
      heading="Basic modal + footer right"
      [props]="[
        { name: 'sdFooterRight', value: 'template' },
        { name: 'body padding', value: '12px 16px' },
    ...
    </demo-section>`}),"components/modal/example-bottom-sheet-actions":t(e({},o["components/modal"]),{html:`<demo-section
      heading="Bottom-sheet actions"
      [props]="[
        { name: 'view', value: 'bottom-sheet' },
        { name: 'sdFooterRight', value: 'template' },
    ...
    </demo-section>`}),"components/modal/example-bottom-sheet-form":t(e({},o["components/modal"]),{html:`<demo-section
      heading="Bottom-sheet form"
      [props]="[
        { name: 'view', value: 'bottom-sheet' },
        { name: 'sdFooterLeft/right', value: 'template' },
    ...
    </demo-section>`}),"components/modal/example-confirm-modal-split-footer":t(e({},o["components/modal"]),{html:`<demo-section
      heading="Confirm modal + split footer"
      [props]="[
        { name: 'sdFooterLeft', value: 'template' },
        { name: 'sdFooterRight', value: 'template' },
    ...
    </demo-section>`}),"components/modal/example-custom-header-left-right":t(e({},o["components/modal"]),{html:`<demo-section
      heading="Custom header left/right"
      [props]="[
        { name: 'sdHeaderLeft', value: 'template' },
        { name: 'sdHeaderRight', value: 'template' },
    ...
    </demo-section>`}),"components/modal/example-long-scroll-body":t(e({},o["components/modal"]),{html:`<demo-section
      heading="Long scroll body"
      [props]="[
        { name: 'max-height', value: '80vh' },
        { name: 'body', value: 'scrollable' },
  ...
  </demo-section>`}),"components/quick-action/example-trong-container":t(e({},o["components/quick-action"]),{html:`<demo-section heading="Trong container" [props]="[{ name: 'contained', value: 'true' }]">
      <sd-quick-action opened contained>
        <span sdMessage>Thanh thao t\xE1c n\u1EB1m trong v\xF9ng cu\u1ED9n c\u1EE7a b\u1EA3ng mobile.</span>
        <sd-button sdAction title="B\u1ECF ch\u1ECDn" (click)="clearSelection()"></sd-button>
      </sd-quick-action>
  ...
  </demo-section>`}),"components/side-drawer/example-create-drawer-split-footer":t(e({},o["components/side-drawer"]),{html:`<demo-section
      heading="Create drawer + split footer"
      [props]="[
        { name: 'sdFooterLeft', value: 'template' },
        { name: 'sdFooterRight', value: 'template' },
    ...
    </demo-section>`}),"components/side-drawer/example-custom-header-left-right":t(e({},o["components/side-drawer"]),{html:`<demo-section
      heading="Custom header left/right"
      [props]="[
        { name: 'sdHeaderLeft', value: 'template' },
        { name: 'sdHeaderRight', value: 'template' },
    ...
    </demo-section>`}),"components/side-drawer/example-filter-drawer":t(e({},o["components/side-drawer"]),{html:`<demo-section
      heading="Filter drawer"
      [props]="[
        { name: 'disableBackdropClose', value: false },
        { name: 'footer', value: 'left/right' },
    ...
    </demo-section>`}),"components/side-drawer/example-locked-drawer-with-explicit-actions":t(e({},o["components/side-drawer"]),{html:`<demo-section
      heading="Locked drawer with explicit actions"
      [props]="[
        { name: 'disableBackdropClose', value: true },
        { name: 'hideClose', value: true },
    ...
    </demo-section>`}),"components/side-drawer/example-long-scroll-content":t(e({},o["components/side-drawer"]),{html:`<demo-section
      heading="Long scroll content"
      [props]="[
        { name: 'content', value: 'overflow auto' },
        { name: 'width', value: '520px' },
    ...
    </demo-section>`}),"components/side-drawer/example-open-inside-a-container":t(e({},o["components/side-drawer"]),{html:`<demo-section
      heading="Open inside a container"
      [props]="[
        { name: 'container', value: 'HTMLElement' },
        { name: 'width', value: '320px' },
  ...
  </demo-section>`}),"components/stepper/example-bang-mau":t(e({},o["components/stepper"]),{html:`<demo-section
      heading="B\u1EA3ng m\xE0u"
      [props]="[{ name: 'color', value: 'primary / success / warning / error' }]"
    ...
    </demo-section>`}),"components/stepper/example-co-ban-horizontal":t(e({},o["components/stepper"]),{html:`<demo-section
    ...
    </demo-section>`}),"components/stepper/example-dieu-khien-tu-ngoai":t(e({},o["components/stepper"]),{html:`<demo-section
      heading="\u0110i\u1EC1u khi\u1EC3n t\u1EEB ngo\xE0i"
      [props]="[
    ...
    </demo-section>`}),"components/stepper/example-editable-false":t(e({},o["components/stepper"]),{html:`<demo-section
    ...
    </demo-section>`}),"components/stepper/example-error-state":t(e({},o["components/stepper"]),{html:`<demo-section
      heading="Error state"
      [props]="[
    ...
    </demo-section>`}),"components/stepper/example-huong-doc":t(e({},o["components/stepper"]),{html:`<demo-section
      heading="H\u01B0\u1EDBng d\u1ECDc"
      [props]="[
    ...
    </demo-section>`}),"components/stepper/example-linear-wizard":t(e({},o["components/stepper"]),{html:`<demo-section
    ...
    </demo-section>`}),"components/stepper/example-optional-step":t(e({},o["components/stepper"]),{html:`<demo-section
    ...
    </demo-section>`}),"components/stepper/example-vi-tri-nhan":t(e({},o["components/stepper"]),{html:`<demo-section heading="V\u1ECB tr\xED nh\xE3n" note="B\u01B0\u1EDBc hi\u1EC7n t\u1EA1i d\xF9ng n\u1EC1n fill v\xE0 icon t\u01B0\u01A1ng ph\u1EA3n; b\u01B0\u1EDBc ho\xE0n th\xE0nh d\xF9ng n\u1EC1n light. \u0110\u01B0\u1EDDng n\u1ED1i th\u1EB3ng h\xE0ng v\u1EDBi t\xE2m icon khi nh\xE3n n\u1EB1m d\u01B0\u1EDBi." [props]="[{ name: 'labelPosition', value: 'end / bottom' }]">
      <div class="row" style="margin-bottom: 12px">
  ...
  </demo-section>`}),"components/tab/example-tab-co-ban":t(e({},o["components/tab"]),{html:`<demo-section heading="Tab c\u01A1 b\u1EA3n" [props]="[{ name: 'label', value: 'text' }, { name: 'headerClass', value: 'bg-white' }, { name: 'bodyClass', value: 'p-16' }]"
    note="N\u1EC1n tr\u1EAFng ch\u1EC9 \xE1p d\u1EE5ng cho header c\u1EE7a group n\xE0y; body gi\u1EEF n\u1EC1n theme v\xE0 c\xF3 kho\u1EA3ng \u0111\u1EC7m ri\xEAng.">
    <div class="full">
      <sd-tab-group headerClass="bg-white" bodyClass="p-16"
        [headerStyle]="{ paddingInline: '8px' }"
  ...
  </demo-section>`}),"components/tab/example-variant-pills":t(e({},o["components/tab"]),{html:`<demo-section heading="Variant pills" [props]="[{ name: 'variant', value: 'pills' }]" note="Pill n\u1EC1n light, ch\u1EEF/icon theo m\xE0u ch\u1EE7 \u0111\u1EA1o. B\u1EA5m l\u1EA1i tab active ho\u1EB7c \u0111i\u1EC1u h\u01B0\u1EDBng b\xE0n ph\xEDm \u0111\u1EC3 ki\u1EC3m tra m\xE0u ch\u1EEF \u1ED5n \u0111\u1ECBnh.">
    <div class="full">
      <sd-tab-group variant="pills" [stretchTabs]="false">
        <sd-tab label="Tu\u1EA7n n\xE0y" icon="today">N\u1ED9i dung tu\u1EA7n n\xE0y.</sd-tab>
        <sd-tab label="Th\xE1ng n\xE0y" icon="calendar_month" [badge]="3">N\u1ED9i dung th\xE1ng n\xE0y.</sd-tab>
  ...
  </demo-section>`}),"components/table/example-action-da-chon-co-menu-con":t(e({},o["components/table"]),{html:`<demo-section
    heading="Action \u0111\xE3 ch\u1ECDn c\xF3 menu con"
    [props]="[
      { name: 'selector.actions[].children', value: 'menu' },
      { name: 'selector.defaultSelected', value: 'callback' }
  ...
  </demo-section>`}),"components/table/example-column-aggregate":t(e({},o["components/table/example-column-aggregate"]),{html:`<ng-template #amountSummary let-items let-value="value" let-kind="kind" let-isComplete="isComplete">
  @if (isComplete) {
    <strong>{{ value | number: '1.0-2' }}</strong>
    <div class="T12R">{{ kind === 'group' ? 'Nh\xF3m' : 'T\u1ED5ng' }} \xB7 {{ items.length }} b\u1EA3n ghi</div>
  } @else {
    <span>Ch\u01B0a \u0111\u1EE7 d\u1EEF li\u1EC7u</span>
  }
</ng-template>
<ng-template #labelSummary let-items let-scope="scope" let-kind="kind" let-value="value">
  <strong>{{ kind === 'group' ? 'T\u1ED5ng nh\xF3m' : scope === 'page' ? 'T\u1ED5ng trang' : 'T\u1ED5ng sau l\u1ECDc' }}</strong>
  <div class="T12R">{{ items.length }} b\u1EA3n ghi \xB7 template-only</div>
</ng-template>
...
<p>C\u1ED9t S\u1ED1 ti\u1EC1n: {{ operation() }}. COUNT \u0111\u1EBFm \xF4 c\xF3 gi\xE1 tr\u1ECB, v\u1EABn t\xEDnh 0 v\xE0 false; m\u1EA3ng r\u1ED7ng kh\xF4ng \u0111\u01B0\u1EE3c t\xEDnh.</p>
@if (option(); as current) {
  <sd-table autoId="aggregate" [option]="current">
    <ng-template sdTableFooterDef="name" let-items="items">
      <div>Footer ri\xEAng: {{ items.length }} d\xF2ng</div>
...
<p>Cha 100, con 40 + 60: roots/leaves = 100, all = 200. Thu g\u1ECDn nh\xE1nh kh\xF4ng \u0111\u1ED5i t\u1ED5ng.</p>
<sd-table autoId="aggregate-tree" [option]="treeOption()" />
<p class="mt-16">Lazy: t\u1ED5ng leaves ch\u01B0a \u0111\u1EA7y \u0111\u1EE7 cho \u0111\u1EBFn khi m\u1EDF nh\xE1nh t\u1EA3i d\u1EEF li\u1EC7u. Aggregate kh\xF4ng t\u1EF1 g\u1ECDi API.</p>
<sd-table autoId="aggregate-lazy" [option]="lazyOption" />`}),"components/table/example-dong-mo-rong":t(e({},o["components/table"]),{html:`<demo-section heading="D\xF2ng m\u1EDF r\u1ED9ng" [props]="[{ name: 'expand', value: 'true' }, { name: 'sdTableExpandDef', value: 'template' }]">
    <div class="table-box">
      <sd-table [option]="expandOption">
        <ng-template [sdTableRowMobileDef]="expandOption" let-row="item"><strong>{{ row.title }}</strong><div>{{ row.assignee }} \xB7 {{ row.progress }}%</div></ng-template>
        <ng-template sdTableExpandDef let-item="item">
  ...
  </demo-section>`}),"components/table/example-external-filters":t(e({},o["components/table"]),{html:`<demo-section heading="External filters"
    [props]="[{ name: 'filter.externalFilters', value: 'string / values / number / daterange' }, { name: 'filter.manualFilter', value: 'true' }]"
    note="B\u1ED9 l\u1ECDc g\u1ECDn, c\xF3 kho\u1EA3ng \u0111\u1EC7m v\u1EDBi m\xE9p section. Nh\u1EADp \u0111i\u1EC1u ki\u1EC7n r\u1ED3i nh\u1EA5n T\xECm ki\u1EBFm; n\xFAt x\xF3a v\xE0 thi\u1EBFt l\u1EADp n\u1EB1m tr\xEAn header. B\u1EA3ng bo nh\u1EB9 \u1EDF c\xE1c g\xF3c ngo\xE0i, v\u1EABn cu\u1ED9n v\xE0 gi\u1EEF header c\u1ED1 \u0111\u1ECBnh.">
    <sd-table autoId="external-filters" [option]="externalFilterOption" />
  ...
  </demo-section>`}),"components/table/example-lenh-dong-phai":t(e({},o["components/table"]),{html:`<demo-section heading="L\u1EC7nh d\xF2ng ph\u1EA3i"
    [props]="[{ name: 'command.align', value: 'right' }, { name: 'command.commands[].disabled', value: '(row) => boolean' }]"
    note="SP-003 minh h\u1ECDa l\u1EC7nh S\u1EEDa v\xE0 X\xF3a b\u1ECB v\xF4 hi\u1EC7u h\xF3a: icon nh\u1EA1t m\xE0u, l\u1EC7nh Xem v\u1EABn s\u1EED d\u1EE5ng \u0111\u01B0\u1EE3c.">
    <div class="table-box">
      <sd-table [option]="commandRightOption"></sd-table>
    </div>
  </demo-section>`}),"components/table/example-mobile-chon-du-lieu":t(e({},o["components/table"]),{html:`<demo-section heading="Mobile ch\u1ECDn d\u1EEF li\u1EC7u"
    [props]="[{ name: 'selector.single', value: 'true' }, { name: 'selector.actions', value: '[]' }, { name: 'selector.visible', value: 'false' }, { name: 'defaultSelected', value: 'callback' }]"
    note="Ba table \u0111\u1ED9c l\u1EADp: ch\u1ECDn \u0111\u01A1n c\xF3 m\u1EB7c \u0111\u1ECBnh; ch\u1ECDn nhi\u1EC1u kh\xF4ng c\xF3 bulk action; ch\u1EC9 c\xF3 l\u1EC7nh d\xF2ng.">
    <sd-table autoId="mobile-single" [option]="mobileSingleOption">
      <ng-template [sdTableRowMobileDef]="mobileSingleOption" let-row="item"><strong>{{ row.name }}</strong><div>{{ row.department }}</div></ng-template>
  ...
  </demo-section>`}),"components/table/example-mobile-qua-nhieu-trang":t(e({},o["components/table"]),{html:`<demo-section heading="Mobile qua nhi\u1EC1u trang"
    [props]="[{ name: 'type', value: 'server' }, { name: 'rowKey', value: 'id' }, { name: 'preserveSelection', value: 'true' }, { name: 'sdTableRowMobileDef', value: 'template' }]"
    note="API gi\u1EA3 l\u1EADp tr\u1EA3 object m\u1EDBi sau m\u1ED7i request. Ch\u1ECDn \u1EDF trang 1 r\u1ED3i sang trang 2; summary v\xE0 callback gi\u1EEF to\xE0n b\u1ED9 selection.">
    <sd-table autoId="mobile-server" [option]="mobileServerOption">
      <ng-template [sdTableRowMobileDef]="mobileServerOption" let-row="item">
    ...
    <p role="status">{{ mobileLog() }}</p>
  </demo-section>`}),"components/table/example-mobile-trong-hop-thoai":t(e({},o["components/table"]),{html:`<demo-section heading="Mobile trong h\u1ED9p tho\u1EA1i"
    [props]="[{ name: 'sdTableRowMobileDef', value: 'template' }, { name: 'sd-modal', value: 'container' }, { name: 'sd-side-drawer', value: 'container' }]"
    note="Card v\xE0 thanh thao t\xE1c n\u1EB1m trong v\xF9ng cu\u1ED9n c\u1EE7a t\u1EEBng table. \u0110\xF3ng h\u1ED9p tho\u1EA1i ho\u1EB7c drawer s\u1EBD d\u1ECDn c\xE1c overlay con.">
    <div class="d-flex gap-8 flex-wrap">
      <sd-button title="M\u1EDF modal" (click)="mobileModal.open()"></sd-button>
  ...
  </demo-section>`}),"components/table/example-quick-search":t(e({},o["components/table"]),{html:`<demo-section heading="Quick search"
    [props]="[{ name: 'filter.quickSearch', value: 'containFields / equalFields / filters' }, { name: 'default', value: 'Signal' }, { name: 'sdTableQuickSearchRightDef', value: 'template' }]"
    note="Ch\u1ECDn tenant \xE1p d\u1EE5ng ngay; nh\u1EADp t\u1EEB kh\xF3a r\u1ED3i nh\u1EA5n Enter. T\xEAn/email t\xECm ch\u1EE9a, m\xE3/S\u0110T t\xECm ch\xEDnh x\xE1c; email kh\xF4ng c\u1EA7n c\xF3 c\u1ED9t. \u0110\u1ED5i tenant \u1EDF m\xE0n A r\u1ED3i chuy\u1EC3n m\xE0n B \u0111\u1EC3 th\u1EA5y l\u1EF1a ch\u1ECDn \u0111\u01B0\u1EE3c gi\u1EEF b\u1EB1ng signal chung. Checkbox b\xEAn ph\u1EA3i l\xE0 UI do consumer ch\xE8n v\xE0o.">
    <div class="d-flex gap-8 mb-16">
      <sd-button title="M\xE0n A" size="sm" [type]="quickScreen() === 'A' ? 'fill' : 'outline'" (click)="quickScreen.set('A')" />
  ...
  </demo-section>`}),"components/table/example-the-mobile-va-thao-tac":t(e({},o["components/table"]),{html:`<demo-section heading="Th\u1EBB mobile v\xE0 thao t\xE1c"
    [props]="[{ name: 'sdTableRowMobileDef', value: 'template' }, { name: 'mobile.rowLabel', value: 'callback' }, { name: 'selector.actions', value: '[\u2026]' }, { name: 'command.commands', value: '[\u2026]' }]"
    note="N\xFAt Th\xEAm canh gi\u1EEFa ph\xEDa tr\xEAn card. L\u1EC1 card hai b\xEAn c\u1ED1 \u0111\u1ECBnh, checkbox nh\u1ECF n\u1EB1m \u0111\xE8 g\xF3c ph\u1EA3i border. Thanh ch\u1ECDn ch\u1EEBa 16px hai \u0111\u1EA7u; nhi\u1EC1u action t\u1EF1 xu\u1ED1ng h\xE0ng \u0111\u1EC1u. Ch\u1EA1m card m\u1EDF sheet thao t\xE1c d\xF2ng; n\xFAt C\xF4ng c\u1EE5 \u1EDF footer m\u1EDF sheet t\u1EA3i l\u1EA1i, xu\u1EA5t, l\u1ECDc v\xE0 s\u1EAFp x\u1EBFp.">
    <sd-table autoId="mobile-employees" [option]="mobileOption">
      <ng-template sdTableCommandHeaderDef>
  ...
  </demo-section>`}),"components/upload-file/example-tai-nhieu-anh-co-gioi-han":t(e({},o["components/upload-file"]),{html:`<demo-section
      heading="T\u1EA3i nhi\u1EC1u \u1EA3nh c\xF3 gi\u1EDBi h\u1EA1n"
      [props]="[
        { name: 'type', value: 'image' },
        { name: 'max', value: '5' },
    ...
    </demo-section>`}),"forms/checkbox/example-che-do-xem":t(e({},o["forms/checkbox"]),{html:`<demo-section
      heading="Ch\u1EBF \u0111\u1ED9 xem"
      [props]="[
        { name: 'viewed', value: 'true' },
        { name: 'viewed', value: 'inline' },
    ...
    </demo-section>`}),"forms/checkbox/example-co-ban":t(e({},o["forms/checkbox"]),{html:`<demo-section
      heading="C\u01A1 b\u1EA3n"
      [props]="[{ name: '[(model)]', value: 'two-way' }]"
      note="Bind [(model)] v\u1EDBi boolean \u2014 hi\u1EC3n th\u1ECB gi\xE1 tr\u1ECB b\xEAn d\u01B0\u1EDBi.">
      <div style="display:flex; flex-direction:column; gap:8px; width:100%">
    ...
    </demo-section>`}),"forms/checkbox/example-kich-thuoc":t(e({},o["forms/checkbox"]),{html:`<demo-section
      heading="K\xEDch th\u01B0\u1EDBc"
      [props]="[{ name: 'size', value: 'sm / md / lg' }]"
      note="C\xF9ng k\xEDch th\u01B0\u1EDBc ch\u1EEF; \xF4 ch\u1ECDn v\xE0 kho\u1EA3ng c\xE1ch nh\xE3n thay \u0111\u1ED5i theo size. md l\xE0 m\u1EB7c \u0111\u1ECBnh.">
      <div style="display:flex; gap:16px; flex-wrap:wrap; align-items:center">
    ...
    </demo-section>`}),"forms/checkbox/example-mau-sac":t(e({},o["forms/checkbox"]),{html:`<demo-section
      heading="M\xE0u s\u1EAFc"
      [props]="[{ name: 'color', value: 'primary / success / warning / error' }]"
      note="Thu\u1ED9c t\xEDnh color thay \u0111\u1ED5i accent.">
      <div style="display:flex; gap:16px; flex-wrap:wrap">
    ...
    </demo-section>`}),"forms/checkbox/example-trang-thai":t(e({},o["forms/checkbox"]),{html:`<demo-section
      heading="Tr\u1EA1ng th\xE1i"
      [props]="[
        { name: 'disabled', value: 'true' },
        { name: 'viewed', value: 'true' },
    ...
    </demo-section>`}),"forms/input/example-kich-thuoc":t(e({},o["forms/input"]),{html:`<demo-section
      heading="K\xEDch th\u01B0\u1EDBc"
      [props]="[{ name: 'size', value: 'sm' }, { name: 'required', value: 'true' }, { name: 'helperText', value: 'string' }]"
      note="Label, tooltip v\xE0 d\u1EA5u b\u1EAFt bu\u1ED9c c\xF9ng h\xE0ng \u1EDF size sm, k\u1EC3 c\u1EA3 khi c\xF3 l\u1ED7i.">
      <div style="width: 320px; max-width: 100%; display: grid; gap: 16px">
  ...
  </demo-section>`}),"forms/switch/example-ben-trong-bang":t(e({},o["forms/switch"]),{html:`<demo-section heading="B\xEAn trong b\u1EA3ng" [props]="[{ name: 'sdTableCellDef', value: 'template' }]" note="Switch trong sd-table t\u1EF1 hi\u1EC3n th\u1ECB c\u1EE1 sm, k\u1EC3 c\u1EA3 khi cell template kh\xF4ng truy\u1EC1n size.">
    <sd-table [option]="switchTable" style="width:100%">
      <ng-template sdTableCellDef="active" let-item="item">
        <sd-switch label="Ho\u1EA1t \u0111\u1ED9ng" [(model)]="item.active" hideInlineError />
      </ng-template>
  ...
  </demo-section>`}),"forms/switch/example-kich-thuoc":t(e({},o["forms/switch"]),{html:`<demo-section heading="K\xEDch th\u01B0\u1EDBc" [props]="[{ name: 'size', value: 'sm / md / lg' }]" note="M\u1EB7c \u0111\u1ECBnh md. Track l\u1EA7n l\u01B0\u1EE3t 36\xD720px, 52\xD732px v\xE0 60\xD736px.">
    <div style="display:flex; flex-wrap:wrap; align-items:center; gap:24px">
      <div style="display:flex; flex-direction:column; gap:12px">
        <sd-switch size="sm" label="sm \xB7 B\u1EADt" [model]="true" />
        <sd-switch size="sm" label="sm \xB7 T\u1EAFt" [model]="false" />
    ...
    <div style="width: 420px; display:flex; flex-direction:column; gap:12px">
    ...
    </demo-section>`}),"services/confirm/example-chon-muc-do":t(e({},o["services/confirm"]),{html:`<demo-section
      heading="Ch\u1ECDn m\u1EE9c \u0111\u1ED9"
      [props]="[{ name: 'withRadio()', value: 'method' }]"
      note="withRadio() \u2013 ch\u1ECDn t\u1EEB danh s\xE1ch radio.">
      <button mat-stroked-button color="primary" (click)="onRadio()">Ch\u1ECDn m\u1EE9c \u0111\u1ED9</button>
    </demo-section>`}),"services/confirm/example-chon-ngay":t(e({},o["services/confirm"]),{html:`<demo-section
      heading="Ch\u1ECDn ng\xE0y"
      [props]="[{ name: 'withDate()', value: 'method' }]"
      note="withDate() \u2013 ch\u1ECDn ng\xE0y v\u1EDBi min/max n\u1EBFu c\u1EA7n.">
      <button mat-stroked-button color="primary" (click)="onDate()">Ch\u1ECDn ng\xE0y hi\u1EC7u l\u1EF1c</button>
    </demo-section>`}),"services/confirm/example-chon-ngay-gio":t(e({},o["services/confirm"]),{html:`<demo-section
      heading="Ch\u1ECDn ng\xE0y gi\u1EDD"
      [props]="[{ name: 'withDatetime()', value: 'method' }]"
      note="withDatetime() \u2013 ch\u1ECDn ng\xE0y v\xE0 gi\u1EDD.">
      <button mat-stroked-button color="primary" (click)="onDatetime()">Ch\u1ECDn l\u1ECBch x\u1EED l\xFD</button>
    </demo-section>`}),"services/confirm/example-chon-phong-ban":t(e({},o["services/confirm"]),{html:`<demo-section
      heading="Ch\u1ECDn ph\xF2ng ban"
      [props]="[{ name: 'withSelect()', value: 'method' }]"
      note="withSelect() \u2013 ch\u1ECDn m\u1ED9t gi\xE1 tr\u1ECB b\u1EB1ng sd-select.">
      <button mat-stroked-button color="primary" (click)="onSelect()">Ch\u1ECDn ph\xF2ng ban</button>
    </demo-section>`}),"services/confirm/example-chon-radio-dang-doc":t(e({},o["services/confirm"]),{html:`<demo-section
      heading="Ch\u1ECDn radio d\u1EA1ng d\u1ECDc"
      [props]="[{ name: 'display', value: 'column' }]"
      note="withRadio(..., { display: 'column' }) \u2013 hi\u1EC3n th\u1ECB danh s\xE1ch radio theo chi\u1EC1u d\u1ECDc.">
      <button mat-stroked-button color="primary" (click)="onRadioColumn()">Ch\u1ECDn ph\xF2ng ban d\u1EA1ng d\u1ECDc</button>
    </demo-section>`}),"services/confirm/example-nhap-ly-do":t(e({},o["services/confirm"]),{html:`<demo-section
      heading="Nh\u1EADp l\xFD do"
      [props]="[{ name: 'withInput()', value: 'method' }]"
      note="withInput() \u2013 y\xEAu c\u1EA7u nh\u1EADp n\u1ED9i dung tr\u01B0\u1EDBc khi x\xE1c nh\u1EADn.">
      <button mat-stroked-button color="primary" (click)="onInput()">Nh\u1EADp l\xFD do t\u1EEB ch\u1ED1i</button>
    ...
    </demo-section>`}),"services/confirm/example-xac-nhan-co-ban":t(e({},o["services/confirm"]),{html:`<demo-section
      heading="X\xE1c nh\u1EADn c\u01A1 b\u1EA3n"
      [props]="[
        { name: 'confirm()', value: 'method' },
        { name: 'icon', value: 'default / info_outline' },
      ...
      <button mat-flat-button color="primary" (click)="onBasic()">X\xE1c nh\u1EADn thao t\xE1c</button>
      <button mat-stroked-button color="primary" (click)="onCustomIcon()">Icon t\xF9y ch\u1EC9nh</button>
    </demo-section>`}),"services/confirm/example-xac-nhan-xoa":t(e({},o["services/confirm"]),{html:`<demo-section
      heading="X\xE1c nh\u1EADn x\xF3a"
      [props]="[{ name: 'confirm()', value: 'method' }]"
      note="T\xF9y ch\u1EC9nh ti\xEAu \u0111\u1EC1, nh\xE3n n\xFAt v\xE0 m\xE0u n\xFAt.">
      <button mat-flat-button color="warn" (click)="onDelete()">X\xF3a b\u1EA3n ghi</button>

...
approved_at: '2026-09-04T13:40:12.459Z'
approved_by: null
...
artifact_id: plan-sdcorejs-angular-angular22-support-r2
artifact_kind: plan
change_control:
  change_reason: Independent final review found the deterministic root package-lock.json required by the approved root npm ci release workflow was omitted from Repository B write scope.
  revision: 2
  supersedes: .sdcorejs/plans/angular/2026-09-02-11-29-angular22-support.md
...
description: Approved scope-reconciliation revision for Angular 22 support and the deterministic root release lock.
env_changes:
...
prohibited_paths:
  ...
  - coverage/**
  - .angular/**
repository_relative_path: .sdcorejs/plans/angular/2026-09-04-20-40-angular22-support-r2.md
requirement_id: REQ-SDANGULAR-ANGULAR22
schema_version: 1
sourceSpecPath: .sdcorejs/specs/angular/2026-09-02-angular22-support-design.md
source_plan: none
source_revision: c68f02d80c78361e9ef4d382230a75fd1c99eb7e
...
approval_hash: sha256:v1:1e5dd5b56d9cb273df28c3a0681784ce57265db3c63b5d43bde010753d533d5c
---

# Angular 22 Multi-Line Support - Approved Plan Revision 2

> Immutable replacement for revision 1. The approved product, API, version and release-gate contracts are unchanged.

## Revision 2 scope reconciliation

- Permit the root package-lock.json as a generated, checked-in Repository B artifact.
- Replace the stale vn-angular root lock identity with a lockfile derived solely from the unchanged sdcorejs-angular-orchestrator root manifest and its existing @changesets/cli development dependency.
- Require root npm ci, root audit and lock-integrity contracts to remain green; no dependency, package API, Portal, Knowledge, utility re-export or publication-scope expansion is authorized.
- Retain all 18 tasks and all 9 phases from revision 1, including the separate Core Release Gate B.
...
plan_context:
  ...
  parallel_candidates:
    ...
    shared_files:
      - Root package.json, root package-lock.json, README files, CHANGELOG and canonical v19 manifests are integration-owner only.
...
- root package-lock.json, generated only from the unchanged root package.json so root npm ci is deterministic
- `versions/v19/SYNC-STATUS.md`
...
- User selection 1 approved revision 2 with the sole scope delta for the deterministic root package-lock.json; all 18 tasks, 9 phases and release gates remain unchanged.
- The user explicitly approved the complete 18-task dependency-first plan and authorized execution of Tasks 1–5 only.
- Independent contract, feasibility, file/test and specialist reviews were incorporated before approval; both final plan audits returned READY.
- Release Gate A remains separately gated: this approval does not authorize merging the Changesets release PR or publishing @sdcorejs/angular-material-datetime@1.0.4.

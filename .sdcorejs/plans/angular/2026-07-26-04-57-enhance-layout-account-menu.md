...
description: Execute the approved TDD rollout for unified V1/V2/V3 account identity, actions, role and reactive notification counts.
approvedAt: 2026-07-26T04:57:46+07:00
...
# Nâng cấp Layout Account Menu - Approved Plan
...
- Thực thi tuần tự theo lựa chọn của user vì canonical source, sync và
  ChromeHeadless có dependency/contention.

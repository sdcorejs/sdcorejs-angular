---
artifact_id: plan-acb-source-row-simplify-r1
artifact_kind: plan
schema_version: 1
change_ref: acb-source-row-simplify
source_spec: .sdcorejs/specs/angular/2026-08-17-14-59-acb-source-row-simplify.md
source_plan: none
commit_policy: with-change
owner: sdcorejs-plan
name: acb-source-row-simplify
description: "TDD plan: advanced mode, single source dropdown, typed static controls, row alignment, JSON copy/paste, then v20/v21 rollout."
...
track: angular
sourceSpecPath: .sdcorejs/specs/angular/2026-08-17-14-59-acb-source-row-simplify.md
sourceDraftPath: .sdcorejs/docs/angular/2026-08-17-15-15-acb-source-row-simplify-plan.md
...
repository_relative_path: .sdcorejs/plans/angular/2026-08-17-15-15-acb-source-row-simplify.md
...
verification_strategy: 
  commands_planned: 
    ...
    - cd versions/v19 && npm run check:i18n
...
approval_hash: "sha256:v1:76ef18b2e1750ef33dce763b81a452786a69e0889360fb8d97e5bfda48d68645"
...
# Đơn giản hoá hàng Nguồn giá trị + copy/paste JSON - Approved Plan
...
- Plan preflight bổ sung ba mắt xích showcase mà approved spec bỏ sót: bump `demoSectionCount` trong `documentation.registry.ts`, bump tổng `335` trong `documentation.registry.spec.ts:27`, và sinh lại `showcase/src/app/docs/generated/example-*.generated.ts` bằng `npm run generate:showcase-examples`. Không mở rộng scope hành vi.
- Lệnh verify đổi từ `npx ng test …` (viết trong spec) sang `npm run test:ci` của `versions/v19`, vì script đó mang `--code-coverage` — thiếu cờ đó thì threshold trong `karma.conf.js` không được đánh giá.
- Song song bị từ chối: ba slice logic cùng ghi `api-contract-source-editor.component.ts`.
- User được thông báo trước rằng working tree đang dirty với đồ sandbox (`sandbox/`, `showcase/projects/`, `showcase/angular.json`, `showcase/package.json`) và task 1 sẽ hỏi 3 lựa chọn trước khi sửa gì.

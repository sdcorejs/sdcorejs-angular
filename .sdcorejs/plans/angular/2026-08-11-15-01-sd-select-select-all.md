---
artifact_id: plan-sd-select-select-all-2026-08-11-r1
artifact_kind: plan
schema_version: 1
change_ref: sd-select-select-all-2026-08-11
source_spec: .sdcorejs/specs/angular/2026-08-11-14-54-sd-select-select-all.md
source_plan: none
commit_policy: with-change
owner: sdcorejs-plan
name: sd-select-select-all
description: Plan TDD 13 task thêm showSelectAll cho sd-select multiple (v19 → sync v20/v21)
contract_id: sd-select-select-all-2026-08-11
requirement_id: req-sd-select-select-all
approved_at: 2026-08-11T08:05:50.888Z
approved_by: null
approval_source: explicit-user-choice
track: angular
sourceSpecPath: .sdcorejs/specs/angular/2026-08-11-14-54-sd-select-select-all.md
...
repository_relative_path: .sdcorejs/plans/angular/2026-08-11-15-01-sd-select-select-all.md
...
verification_strategy:
  package_manager: npm
  commands_planned:
    - "versions/v19: npx ng test sdcorejs-angular --watch=false --browsers=ChromeHeadless --include='**/select/src/select.component.spec.ts'"
    - 'versions/v19: npm run check:i18n-parity'
    - 'versions/v19: npm run build'
    - 'root: npm run generate:showcase-examples && npm run test:showcase-examples'
    - 'root: npm run sync && npm run check:sync'
approval_hash: sha256:v1:b717e19b07e3791065bdd1a631d45a038d424d82cea8b2a9d2c4a80dde37c16d
approved_plan_hash: sha256:v1:b717e19b07e3791065bdd1a631d45a038d424d82cea8b2a9d2c4a80dde37c16d
supersedes: null
change_control:
  revision: 1
  supersedes: null
...
# sd-select multiple "Chọn tất cả" (showSelectAll) - Approved Plan

...
source_revision: 3ce0544d3754b42f46a274178066756f017af8b3
parent_repository_id: null
parent_references: []
approved_at: "2026-09-02T04:18:33.027Z"
approved_by: null
...
sourceDraftPath: .sdcorejs/docs/angular/2026-09-02-11-18-angular22-support-spec.md
...
# Angular 22 support - Approved Spec
...
- The user approved the two-stage production-safe approach and then explicitly approved this complete design contract.
- Independent review findings were incorporated before approval: final-only `latest`, separate release authorizations, explicit v22 manifest normalization, Angular ESLint 22, Node 22.22.3 cross-major CI, trusted-publishing invariants, and exact package API baselines.

...
description: Accessibility contract for SdSection, Sidebar v1 and SdBadge with the exact v2.1 multi-major release.
...
sourceDraftPath: .sdcorejs/docs/angular/2026-08-30-11-42-shared-components-accessibility-v2-1-spec.md
...
# Accessibility cho shared components gốc, release v2.1 - Approved Spec

---
name: enhance-layout-account-menu
description: Approved contract for unified V1/V2/V3 account identity, typed actions, role metadata and reactive notification counts.
contract_id: sdcorejs-angular-layout-account-menu-v2
requirement_id: layout-account-menu-20260725
approvedAt: 2026-07-25T16:14:36+07:00
...
sourceDraftPath: .sdcorejs/docs/angular/2026-07-25-15-27-enhance-layout-account-menu-spec.md
...
# Nâng cấp Layout Account Menu - Approved Spec
...
- Dùng đúng public field names `updateProfile`, `setting` và `notification`
  (số ít).
- Approved as drafted on attempt 1/3.

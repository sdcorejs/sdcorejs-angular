...
Tag `v<release-suffix>` (vd `v2.12`) → CI chuẩn bị `19.2.12` / `20.2.12` / `21.2.12` / `22.2.12`, rồi sinh `published-docs` và commit về `main` sau khi toàn bộ transaction thành công.

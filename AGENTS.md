...
Tag `v<release-suffix>` (vd `v2.11`) → CI chuẩn bị `19.2.11` / `20.2.11` / `21.2.11` / `22.2.11`, rồi sinh `published-docs` và commit về `main` sau khi toàn bộ transaction thành công.

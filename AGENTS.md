...
Tag `v<release-suffix>` (vd `v2.10`) → CI chuẩn bị `19.2.10` / `20.2.10` / `21.2.10` / `22.2.10`, rồi sinh `published-docs` và commit về `main` sau khi toàn bộ transaction thành công.

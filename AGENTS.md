...
Tag `v<release-suffix>` (vd `v2.13`) → CI chuẩn bị `19.2.13` / `20.2.13` / `21.2.13` / `22.2.13`, rồi sinh `published-docs` và commit về `main` sau khi toàn bộ transaction thành công.

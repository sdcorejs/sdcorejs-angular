...
const COMPONENT_PAGES = [
  ...
  defineDocPage({
    ...
    slug: 'audit-diff',
    title: 'Audit Diff',
    description: 'Semantic before/after diff for nested records and stable-key arrays with formatting and redaction.',
    selector: 'sd-audit-diff',
    importPath: '@sdcorejs/angular/components/audit-diff',
    publishedDocId: 'components/audit-diff/sd-audit-diff',
    keywords: ['audit', 'diff', 'before after', 'change history', 'redaction'],
    status: 'stable',
    demoSectionCount: 4,
    loadComponent: () => import('../../pages/components/audit-diff/audit-diff-demo.component').then(m => m.AuditDiffDemoComponent),
  }),
  defineDocPage({
    category: 'components',
    slug: 'avatar',
  ...
  defineDocPage({
    ...
    slug: 'breadcrumb',
    title: 'Breadcrumb',
    description: 'Static hoặc router-generated breadcrumb với async labels, overflow và semantic navigation.',
    selector: 'sd-breadcrumb',
    importPath: '@sdcorejs/angular/components/breadcrumb',
    publishedDocId: 'components/breadcrumb/sd-breadcrumb',
    keywords: ['breadcrumb', 'navigation', 'router', 'async label'],
    status: 'stable',
    demoSectionCount: 3,
  ...
  defineDocPage({
    ...
    slug: 'data-state',
    title: 'Data State',
    description: 'Accessible loading, empty, error, forbidden và transparent success presentation.',
    selector: 'sd-data-state',
    importPath: '@sdcorejs/angular/components/data-state',
  ...
  defineDocPage({
    ...
    publishedDocId: 'components/form-generic/sd-form-generic',
  ...
  defineDocPage({
    ...
    slug: 'job-progress',
    title: 'Job Progress',
    description: 'Accessible determinate/indeterminate progress bound to direct state or the shared task registry.',
    selector: 'sd-job-progress',
    importPath: '@sdcorejs/angular/components/job-progress',
    publishedDocId: 'components/job-progress/sd-job-progress',
    keywords: ['progress', 'background job', 'polling', 'SSE', 'cancel', 'retry'],
    status: 'stable',
    demoSectionCount: 4,
    loadComponent: () => import('../../pages/components/job-progress/job-progress-demo.component').then(m => m.JobProgressDemoComponent),
  }),
  defineDocPage({
    category: 'components',
    slug: 'mini-editor',
  ...
  defineDocPage({
    ...
    keywords: ['image', 'pdf', 'lightbox', 'viewer', 'outline', 'continuous', 'print'],
    status: 'stable',
    demoSectionCount: 4,
...
const FORM_PAGES = [
  ...
  defineDocPage({
    ...
    slug: 'entity-picker',
    title: 'Entity Picker',
    description: 'Generic key-based picker compose QueryBar, Table và Modal cho server paging, hydration và templates.',
    selector: 'sd-entity-picker',
    importPath: '@sdcorejs/angular/forms/entity-picker',
    publishedDocId: 'forms/entity-picker/sd-entity-picker',
    keywords: ['entity picker', 'server paging', 'hydration', 'selection'],
    status: 'stable',
    demoSectionCount: 4,
    loadComponent: () => import('../../pages/forms/entity-picker/entity-picker-demo.component').then(m => m.EntityPickerDemoComponent),
  }),
  defineDocPage({
    category: 'forms',
    slug: 'input',
  ...
  defineDocPage({
    ...
    slug: 'time',
    title: 'Time',
    description: 'Nhập hoặc chọn giờ thuần HH:mm, không mang ngày hay múi giờ.',
    selector: 'sd-time',
    importPath: '@sdcorejs/angular/forms/time',
    publishedDocId: 'forms/time/sd-time',
    keywords: ['time picker', 'hh:mm', 'step minutes', 'schedule'],
    status: 'stable',
    demoSectionCount: 4,
    loadComponent: () => import('../../pages/forms/time/time-demo.component').then(m => m.TimeDemoComponent),
  }),
  defineDocPage({
    category: 'forms',
    slug: 'time-range',
    title: 'Time Range',
    description: 'Khoảng giờ time-only với validation thứ tự, biên và open-ended.',
    selector: 'sd-time-range',
    importPath: '@sdcorejs/angular/forms/time-range',
    publishedDocId: 'forms/time-range/sd-time-range',
    keywords: ['time range', 'working hours', 'from to', 'open ended'],
    status: 'stable',
    demoSectionCount: 4,
    loadComponent: () => import('../../pages/forms/time-range/time-range-demo.component').then(m => m.TimeRangeDemoComponent),
  }),
  defineDocPage({
    category: 'forms',
    slug: 'tree-select',
    title: 'Tree Select',
    description: 'Stable-key tree picker compose SdTree static/lazy với cascade, indeterminate, keyboard và retry.',
    selector: 'sd-tree-select',
    importPath: '@sdcorejs/angular/forms/tree-select',
    publishedDocId: 'forms/tree-select/sd-tree-select',
    keywords: ['tree select', 'lazy tree', 'cascade', 'indeterminate'],
    status: 'stable',
    demoSectionCount: 4,
    loadComponent: () => import('../../pages/forms/tree-select/tree-select-demo.component').then(m => m.TreeSelectDemoComponent),
  }),
] as const;
...
const SERVICE_PAGES = [
  ...
  defineDocPage({
    ...
    slug: 'persistence',
    title: 'Persistence',
    description: 'Versioned graph serialization, deterministic identity, bounded envelopes and SSR-safe storage adapters.',
    selector: null,
    importPath: '@sdcorejs/angular/services/persistence',
    publishedDocId: 'services/persistence/sd-persistence',
    keywords: ['serializer', 'date', 'map', 'set', 'circular reference', 'storage envelope'],
    status: 'stable',
    demoSectionCount: 4,
    loadComponent: () => import('../../pages/services/persistence/persistence-demo.component').then(m => m.PersistenceDemoComponent),
  }),
  defineDocPage({
    category: 'services',
    slug: 'notify',
  ...
  defineDocPage({
    ...
    slug: 'task',
    title: 'Task',
    description: 'Stable-ID task registry with shared polling/SSE connections, bounded retry and deterministic teardown.',
    selector: null,
    importPath: '@sdcorejs/angular/services/task',
    publishedDocId: 'services/task/sd-task',
    keywords: ['background task', 'polling', 'server-sent events', 'backoff', 'registry'],
    status: 'stable',
    demoSectionCount: 4,
    loadComponent: () => import('../../pages/services/task/task-demo.component').then(m => m.TaskDemoComponent),
  }),
  defineDocPage({
    category: 'services',
    slug: 'unsaved-changes',
    title: 'Unsaved Changes',
    description: 'Scoped dirty registry, FormGroup adapter và fail-closed guards cho navigation, modal, drawer và tab.',
    selector: null,
    importPath: '@sdcorejs/angular/services/unsaved-changes',
    publishedDocId: 'services/unsaved-changes/sd-unsaved-changes',
    keywords: ['unsaved changes', 'dirty form', 'canDeactivate', 'beforeunload', 'close guard'],
    status: 'stable',
    demoSectionCount: 4,
    loadComponent: () =>
      import('../../pages/services/unsaved-changes/unsaved-changes-demo.component').then(m => m.UnsavedChangesDemoComponent),
  }),
  defineDocPage({
    category: 'services',
    slug: 'viewport',
    title: 'Viewport',
    description: 'Signal SSR-safe cho kích thước và breakpoint mobile/tablet/desktop từ một resize listener.',
    selector: null,
    importPath: '@sdcorejs/angular/services/viewport',
    publishedDocId: 'services/viewport/sd-viewport',
    keywords: ['responsive', 'viewport', 'breakpoint', 'signals', 'SSR'],
    status: 'stable',
    demoSectionCount: 3,
    loadComponent: () => import('../../pages/services/viewport/viewport-demo.component').then(m => m.ViewportDemoComponent),
  }),
] as const;
...
const PUBLISHED_ONLY_PAGES = [
  ...
  definePublishedDocPage({
    category: 'components',
    slug: 'ckeditor-styles',
    title: 'CKEditor Styles',
    description: 'Styles-only component that loads the global CKEditor 5 stylesheet on demand for the editor components.',
    selector: 'sd-ckeditor-styles',
    importPath: '@sdcorejs/angular/components/ckeditor-styles',
    publishedDocId: 'components/ckeditor-styles/sd-ckeditor-styles',
    keywords: ['ckeditor', 'styles', 'global css', 'encapsulation'],
  }),
  definePublishedDocPage({
    category: 'forms',
    slug: 'label',
  ...
  definePublishedDocPage({
    category: 'forms',
    slug: 'form-control-connector',
    title: 'Internal Form-Control Connector',
    description: 'Shared form-control lifecycle connector for SDCoreJS control maintainers.',
    importPath: '@sdcorejs/angular/forms/models',
    publishedDocId: 'forms/models/sd-form-control-connector',
    keywords: ['form control', 'connector', 'lifecycle', 'internal'],
  }),
  definePublishedDocPage({
    category: 'forms',
    slug: 'template-directives',
    title: 'Form Template Directives',
    description: 'Marker directives that project a custom suffix, label, view or option template into a form control.',
    selector: 'sdSuffixDef, sdLabelDef, sdViewDef, sdItemDef',
    importPath: '@sdcorejs/angular/forms/directives',

...
const COMPONENT_PAGES = [
  ...
  defineDocPage({
    ...
    slug: 'card',
    title: 'Card',
    description: 'Selectable content shell with standalone, single, multiple, object comparison, disabled and color states.',
    selector: 'sd-card, sd-card-group',
    importPath: '@sdcorejs/angular/components/card',
    publishedDocId: 'components/card/sd-card',
    keywords: ['selection', 'toggle', 'filter', 'compareWith', 'multiple'],
    status: 'stable',
    demoSectionCount: 5,
  ...
  defineDocPage({
    ...
    slug: 'side-drawer',
    title: 'Side Drawer',
    description: 'Panel bên phải cho form, detail và filter với các slot header/footer; mở trên cả trang hoặc gọn trong một vùng chứa.',
    ...
    keywords: ['drawer', 'panel', 'detail', 'form', 'container'],
    status: 'stable',
    demoSectionCount: 7,

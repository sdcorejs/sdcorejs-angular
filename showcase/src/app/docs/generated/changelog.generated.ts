        ...
        "items": [
          {
            ...
            "children": [
              ...
              {
                "text": "**Tri-state `required`, next to `type`.** `undefined` = not declared, `true` = mandatory, `false` = explicitly optional. No `required: string[]` array on the parent, and property names stay a `Record<string, Node>`.",
                "ordered": false,
                "children": []
              },
              {
              ...
              {
                "text": "70 new i18n keys across all five locales, docs in `components/api-contract-builder/sd-api-contract-builder.md`, and a six-section showcase page at `/components/api-contract-builder`.",
                "ordered": false,
                "children": []
              }
            ]

    ...
    <demo-page
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-kich-thuoc') {
        <demo-section
          ...
          note="Cùng kích thước chữ; ô chọn và khoảng cách nhãn thay đổi theo size. md là mặc định.">
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-mau-sac') {
        <demo-section
          ...
          note="Thuộc tính color thay đổi accent.">
        ...
        <demo-section
          ...
          <div style="display:flex; flex-direction:column; gap:8px; width:100%">
            <sd-checkbox
              ...
              [(model)]="errAccept"
              [form]="formErr"
              [inlineError]="'Bạn phải đồng ý điều khoản'"></sd-checkbox>
      ...
      @if (!demoPage.focusedSectionId || demoPage.focusedSectionId === 'example-che-do-xem') {
        <demo-section
          ...
          note="viewed=true hiện chữ Có/Không; 'inline' vẫn bấm được, disabled+inline thì xem tĩnh.">
          <div style="display:flex; gap:16px; flex-wrap:wrap">

...
@Component({
  ...
  template: `
    <demo-page
      ...
      <demo-section heading="3 biến thể (type)">
      ...
      <demo-section heading="Bảng màu — type=round (color)">
      ...
      <demo-section heading="Bảng màu — type=tag (color)">
      ...
      <demo-section heading="Bảng màu — type=icon (color)">
      ...
      <demo-section heading="Kích thước — type=round (size)">
      ...
      <demo-section heading="Kích thước — type=round + icon (size)">
      ...
      <demo-section heading="Kích thước — type=tag (size)">
      ...
      <demo-section heading="Có description (type=icon | type=tag)">
      ...
      <demo-section heading="Counter (type=round, title là số)">

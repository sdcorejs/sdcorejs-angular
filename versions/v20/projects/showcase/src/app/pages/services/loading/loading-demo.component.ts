...
@Component({
  ...
  template: `
    <demo-page #demoPage title="Loading" description="SdLoadingService – phủ spinner lên một phần tử bất kỳ qua CSS selector. Hai API chính: start(selector) và stop(selector). Mặc định selector là 'body'.">

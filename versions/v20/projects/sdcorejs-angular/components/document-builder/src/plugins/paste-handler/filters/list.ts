 ...
 * @internal
 */
export function unwrapParagraphInListItem(documentFragment: ViewDocumentFragment, writer: ViewUpcastWriter): void {
 ...
 */
function createNewEmptyList(listStyle: ReturnType<typeof detectListStyle>, writer: ViewUpcastWriter, hasMultiLevelListPlugin: boolean) {

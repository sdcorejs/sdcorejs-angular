...
| `clearable`       | `boolean`                                       | `false`     | Shows the inner `<sd-input>` clear button when the color has a value and the field is editable/not required.                                                                                                                                                                                                                                        |
...
- With `clearable`, the built-in `<sd-input>` clear button appears only when editable, non-empty, and not required.

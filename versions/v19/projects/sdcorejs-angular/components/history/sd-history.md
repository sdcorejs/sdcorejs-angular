...
- Activity feed for an entity ("B�xi @user, lúc dd/MM/yyyy HH:mm, ghi chú: ...")
- Inside a `<sd-modal>` titled "L�9ch sử thay ��"i"
- Tab content of a record detail screen ("Hoạt ��"ng", "L�9ch sử")
...
interface SdHistoryItemType {
  title: string;            // Required � primary line ("Tạo phiếu", "Gửi duy�!t")
  ...
  actor?: string;           // Username (rendered as "B�xi @<actor>")
...
- Each event sits inside a card to the right of its dot, holding:
  ...
  - **Meta row**: smaller grey text `B�xi @<actor> · <source>`
...
events: SdHistoryItemType[] = [
  ...
  { title: 'Gửi duy�!t', date: '2025-05-01T10:15:00Z', actor: 'nghiatt15', source: 'Web',
    status: { title: 'Chờ duy�!t', color: 'warning', icon: 'hourglass_empty' } },
  { title: 'Phê duy�!t', date: '2025-05-01T14:02:00Z', actor: 'lead.user', source: 'Mobile',
    status: { title: 'Đã duy�!t', color: 'success', icon: 'check' },
    description: 'Đ�ng ý v�:i �iều khoản �ã �ược rà soát.' },
];
```

### 2. Inside a modal
```html
<sd-modal #m title="L�9ch sử thay ��"i" width="md">
...
```html
<sd-tab title="L�9ch sử" key="history">

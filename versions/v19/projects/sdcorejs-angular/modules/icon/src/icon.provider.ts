 ...
 */
export const SD_ICON_CONFIGURATION = new InjectionToken<SdIconResolvedConfig>('SD_ICON_CONFIGURATION', {
  providedIn: 'root',
 ...
 */
export function provideSdIcon(config: SdIconConfig = {}): EnvironmentProviders {
 ...
 */
export function resolveSdIconConfig(config: SdIconConfig = {}): SdIconResolvedConfig {
  return {

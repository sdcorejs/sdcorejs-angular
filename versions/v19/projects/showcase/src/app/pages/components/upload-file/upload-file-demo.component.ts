...
@Component({
  ...
  template: `
    <demo-page
      ...
      <demo-section heading="Tải nhiều ảnh có giới hạn (tối đa 5, ≤ 2MB/file)">
      ...
      <demo-section heading="Tải tài liệu (PDF, Word, Excel)">
        <div class="control-box">
          <sd-upload-file
      ...
      <demo-section heading="Vô hiệu hóa (xem chỉ đọc)">
        <div class="control-box">
          <sd-upload-file
            label="Đã đính kèm"
            type="file"

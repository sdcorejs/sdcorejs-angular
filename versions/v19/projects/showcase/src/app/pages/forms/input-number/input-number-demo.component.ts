...
@Component({
  ...
  template: `
    <demo-page title="Input Number" description="sd-input-number – nhập số có format ngăn cách hàng nghìn, hỗ trợ min/max, prefix/suffix và các trạng thái khoá.">
      <demo-section heading="cơ bản" note="Tự động format khi gõ.">
      ...
      <demo-section heading="Validator (required + min=10 + max=100)" note="min=10, max=100. Bấm Kiểm tra để hiện lỗi.">
        <div style="width: 320px; display:flex; flex-direction:column; gap:12px">

...
@Component({
  ...
  template: `
    <demo-page title="Date Range" description="sd-date-range – chọn khoảng thời gian từ – đến. Model là object { from, to } dạng ISO.">
      <demo-section heading="cơ bản" note="Chọn ngày bắt đầu và ngày kết thúc trong cùng popup.">
      ...
      <demo-section heading="Validator (required)" note="Để trống và bấm Kiểm tra.">
      ...
      <demo-section heading="Trạng thái (state)" note="Khoảng đã set sẵn.">

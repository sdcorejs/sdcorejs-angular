...
@Component({
  ...
  standalone: true,
  template: '<span data-testid="desktop-v1"></span>',
})
...
@Component({
  ...
  standalone: true,
  template: '<span data-testid="mobile-v1"></span>',
})
...
@Component({
  ...
  standalone: true,
  template: '<span data-testid="desktop-v2"></span>',
})
...
@Component({
  ...
  standalone: true,
  template: '<span data-testid="mobile-v2"></span>',
})
...
@Component({
  ...
  standalone: true,
  template: '<span data-testid="desktop-v3"></span>',
})
...
@Component({
  ...
  standalone: true,
  template: '<span data-testid="mobile-v3"></span>',
})

...
treeEmbeddedOption: SdTableOption<TreeDemoItem> = {
  ...
  columns: [
    { field: 'name', title: 'Tên', type: 'string', width: '250px' },
    { field: 'type', title: 'Loại', type: 'string', width: '150px' },
  ],
  items: () => [
    {
      id: 1, name: 'Công ty ABC', type: 'Công ty',
      children: [
        { id: 11, name: 'Phòng IT', type: 'Phòng ban', children: [
          { id: 111, name: 'Team Frontend', type: 'Team' },
          { id: 112, name: 'Team Backend', type: 'Team' },
        ]},
        { id: 12, name: 'Phòng HR', type: 'Phòng ban' },
      ],
    },
    { id: 2, name: 'Công ty XYZ', type: 'Công ty' },
  ],
};
```

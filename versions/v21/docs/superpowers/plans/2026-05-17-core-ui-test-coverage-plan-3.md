...
- [ ] **Step 4: Audit `sd-quick-action.md`** per 14-mục checklist.
...
- [ ] **Step 2: Append §6.3 to Plan 1 design doc** with actual commit SHAs and test counts (fill in template above with real data from Tasks 1-10)

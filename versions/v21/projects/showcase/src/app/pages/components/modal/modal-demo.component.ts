...
@Component({
  ...
  template: `
    <demo-page
      ...
      <demo-section heading="Modal cơ bản" [props]="[{ name: 'open()', value: 'method' }, { name: 'width', value: 'md' }, { name: 'sdFooterRight', value: 'template' }]">
      ...
      <demo-section heading="Xác nhận xóa" [props]="[{ name: 'width', value: 'sm' }, { name: 'sdFooterLeft', value: 'template' }, { name: 'sdFooterRight', value: 'template' }]">
      ...
      <demo-section heading="Modal lớn + header-right" [props]="[{ name: 'width', value: 'lg' }, { name: 'sdHeaderRight', value: 'template' }]">
      ...
      <demo-section heading="Bottom-sheet" [props]="[{ name: 'view', value: 'bottom-sheet' }, { name: 'open()', value: 'method' }]">

...
@Component({
  ...
  template: `
    <demo-page title="Switch" description="sd-switch – công tắc bật/tắt boolean. Hỗ trợ màu chủ đề, disabled / viewed.">
      <demo-section heading="cơ bản" note="Bind hai chiều, hiển thị trạng thái ngay bên cạnh.">
      ...
      <demo-section heading="Màu sắc (color)" note="Thuộc tính color thay đổi accent track.">
